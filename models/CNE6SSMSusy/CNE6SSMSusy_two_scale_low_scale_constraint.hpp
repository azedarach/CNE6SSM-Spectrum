...
#ifndef CNE6SSMSusy_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define CNE6SSMSusy_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "CNE6SSMSusy_low_scale_constraint.hpp"
...
template<>
class CNE6SSMSusy_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   CNE6SSMSusy_low_scale_constraint();
   CNE6SSMSusy_low_scale_constraint(CNE6SSMSusy<Two_scale>*, const QedQcd&);
   virtual ~CNE6SSMSusy_low_scale_constraint();
   virtual void apply();
