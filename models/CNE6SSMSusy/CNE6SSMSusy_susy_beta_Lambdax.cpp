 ...
 */
double CNE6SSMSusy_susy_parameters::calc_beta_Lambdax_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CNE6SSMSusy_susy_parameters::calc_beta_Lambdax_two_loop(const Susy_traces& susy_traces) const
{
   const double tracefdAdjfd = TRACE_STRUCT.tracefdAdjfd;
   const double tracefuAdjfu = TRACE_STRUCT.tracefuAdjfu;
   const double traceYdAdjYd = TRACE_STRUCT.traceYdAdjYd;
