...
// File generated at Sun 19 Apr 2015 20:24:40
 ...
 */
Eigen::Matrix<double,3,2> CNE6SSMSusy_susy_parameters::calc_beta_fu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,2> CNE6SSMSusy_susy_parameters::calc_beta_fu_two_loop(const Susy_traces& susy_traces) const
{
   const double tracefuAdjfu = TRACE_STRUCT.tracefuAdjfu;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
