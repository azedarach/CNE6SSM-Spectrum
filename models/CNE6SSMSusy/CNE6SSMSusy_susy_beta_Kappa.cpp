 ...
 */
Eigen::Matrix<double,3,3> CNE6SSMSusy_susy_parameters::calc_beta_Kappa_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CNE6SSMSusy_susy_parameters::calc_beta_Kappa_two_loop(const Susy_traces& susy_traces) const
{
