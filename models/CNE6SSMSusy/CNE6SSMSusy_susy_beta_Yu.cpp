 ...
 */
Eigen::Matrix<double,3,3> CNE6SSMSusy_susy_parameters::calc_beta_Yu_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> CNE6SSMSusy_susy_parameters::calc_beta_Yu_two_loop(const Susy_traces& susy_traces) const
{
   const double tracefuAdjfu = TRACE_STRUCT.tracefuAdjfu;
   const double traceYuAdjYu = TRACE_STRUCT.traceYuAdjYu;
