...
#ifndef CNE6SSMSusy_susy_parameters_H
#define CNE6SSMSusy_susy_parameters_H
...
class CNE6SSMSusy_susy_parameters : public Beta_function {
public:
   explicit CNE6SSMSusy_susy_parameters();
   CNE6SSMSusy_susy_parameters(double scale_, double loops_, double thresholds_,
   ...
   virtual ~CNE6SSMSusy_susy_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual const Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);

   CNE6SSMSusy_susy_parameters calc_beta() const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const CNE6SSMSusy_susy_parameters&);
