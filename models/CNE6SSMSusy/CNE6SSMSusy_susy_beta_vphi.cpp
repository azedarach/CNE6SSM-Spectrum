 ...
 */
double CNE6SSMSusy_susy_parameters::calc_beta_vphi_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CNE6SSMSusy_susy_parameters::calc_beta_vphi_two_loop(const Susy_traces& susy_traces) const
{
