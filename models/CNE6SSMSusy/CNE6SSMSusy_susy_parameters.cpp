...
#define CLASSNAME CNE6SSMSusy_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces

CNE6SSMSusy_susy_parameters::CNE6SSMSusy_susy_parameters()
   : Beta_function()
...
Eigen::ArrayXd CNE6SSMSusy_susy_parameters::beta() const
{
   return calc_beta().get();
}

CNE6SSMSusy_susy_parameters CNE6SSMSusy_susy_parameters::calc_beta() const
{
...
void CNE6SSMSusy_susy_parameters::clear()
{
   reset();
...
const Eigen::ArrayXd CNE6SSMSusy_susy_parameters::get() const
{
...
void CNE6SSMSusy_susy_parameters::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
           "susy parameters:\n"
           "----------------------------------------\n";
...
void CNE6SSMSusy_susy_parameters::set(const Eigen::ArrayXd& pars)
{
   Yd(0,0) = pars(0);
   Yd(0,1) = pars(1);
   Yd(0,2) = pars(2);
...
void CNE6SSMSusy_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
...
std::ostream& operator<<(std::ostream& ostr, const CNE6SSMSusy_susy_parameters& susy_pars)
{
