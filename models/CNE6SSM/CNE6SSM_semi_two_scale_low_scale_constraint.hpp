...
#ifndef CNE6SSM_SEMI_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define CNE6SSM_SEMI_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "CNE6SSM_semi_low_scale_constraint.hpp"
...
template<>
class CNE6SSM_semianalytic_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   CNE6SSM_semianalytic_low_scale_constraint();
   CNE6SSM_semianalytic_low_scale_constraint(CNE6SSM_semianalytic<Two_scale>*, const QedQcd&);
   virtual ~CNE6SSM_semianalytic_low_scale_constraint();
   virtual void apply();
