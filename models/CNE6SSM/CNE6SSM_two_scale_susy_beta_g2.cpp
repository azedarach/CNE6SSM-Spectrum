 ...
 */
double CNE6SSM_susy_parameters::calc_beta_g2_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CNE6SSM_susy_parameters::calc_beta_g2_two_loop(const Susy_traces& susy_traces) const
{
