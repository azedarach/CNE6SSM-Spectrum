 ...
 */
double CNE6SSM_susy_parameters::calc_beta_g1_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double CNE6SSM_susy_parameters::calc_beta_g1_two_loop(const Susy_traces& susy_traces) const
{
