...
CNE6SSM_low_scale_constraint<Two_scale>::CNE6SSM_low_scale_constraint(const CNE6SSM_input_parameters& inputPars_, const QedQcd& oneset_)
   : Constraint<Two_scale>()
   , model(0)
...
void CNE6SSM_low_scale_constraint<Two_scale>::set_input_parameters(const CNE6SSM_input_parameters& inputPars_)
{
   inputPars = inputPars_;
}
