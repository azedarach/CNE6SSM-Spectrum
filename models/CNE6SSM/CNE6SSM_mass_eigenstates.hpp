...
protected:
   ...
   CNE6SSM_physical drbar;  ///< contains the running masses and mixings
...
private:
   ...
   struct Thread {
      ...
      Thread(CNE6SSM_mass_eigenstates* model_, Memfun_t fun_)
...
std::ostream& operator<<(std::ostream&, const CNE6SSM_mass_eigenstates&);
