...
void write_CNE6SSM_inputs(const CNE6SSM_input_parameters<Two_scale>&,
                          std::ostream &, std::size_t);
void write_CNE6SSM_inputs_list(std::ostream &, std::size_t);
void write_CNE6SSM_inputs(
   const CNE6SSM_semianalytic_input_parameters<Two_scale>&,
   std::ostream &, std::size_t
   );
...
class CNE6SSM_semianalytic_pole_mass_writer {
public:
   CNE6SSM_semianalytic_pole_mass_writer();
   ~CNE6SSM_semianalytic_pole_mass_writer() {}

   template <class T>
   void extract_pole_masses(const CNE6SSM_semianalytic<T>&);
   void write_pole_masses_comment_line(std::ostream &) const;
   void write_pole_masses_line(std::ostream &) const;
...
private:
   ...
   CNE6SSM_semianalytic_input_parameters<Two_scale> pole_masses_inputs;
   Problems<CNE6SSM_info::NUMBER_OF_PARTICLES> pole_masses_problems;
...
class CNE6SSM_semianalytic_drbar_values_writer {
public:
   CNE6SSM_semianalytic_drbar_values_writer();
   ~CNE6SSM_semianalytic_drbar_values_writer() {}

   template <class T>
   void extract_drbar_masses(const CNE6SSM_semianalytic<T>&);
   template <class T>
   void extract_drbar_susy_pars(const CNE6SSM_semianalytic<T>&);
   template <class T>
   void extract_drbar_soft_pars(const CNE6SSM_semianalytic<T>&);
   template <class T>
   void extract_drbar_mixings(const CNE6SSM_semianalytic<T>&);
...
private:
   ...
   CNE6SSM_semianalytic_input_parameters<Two_scale> drbar_masses_inputs;
   CNE6SSM_semianalytic_input_parameters<Two_scale> drbar_susy_pars_inputs;
   CNE6SSM_semianalytic_input_parameters<Two_scale> drbar_soft_pars_inputs;
   CNE6SSM_semianalytic_input_parameters<Two_scale> drbar_mixings_inputs;
...
class CNE6SSM_semianalytic_coefficients_writer {
public:
   CNE6SSM_semianalytic_coefficients_writer();
   ~CNE6SSM_semianalytic_coefficients_writer() {}
   ...
   template <class T>
   void extract_coefficients(const CNE6SSM_semianalytic<T>&);
...
private:
   ...
   CNE6SSM_semianalytic_input_parameters<Two_scale> coefficients_inputs;

   Problems<CNE6SSM_info::NUMBER_OF_PARTICLES> coefficients_problems;
...
template <class T>
void CNE6SSM_semianalytic_pole_mass_writer::extract_pole_masses(
   const CNE6SSM_semianalytic<T>& model
   )
{
   pole_masses.clear();
   pole_masses_scale = model.get_scale();
...
template <class T>
void CNE6SSM_semianalytic_drbar_values_writer::extract_drbar_masses(
   const CNE6SSM_semianalytic<T>& model
   )
{
   drbar_masses.clear();
...
template <class T>
void CNE6SSM_drbar_values_writer::extract_drbar_susy_pars(
   const CNE6SSM<T>& model
   )
{
...
template <class T>
void CNE6SSM_semianalytic_drbar_values_writer::extract_drbar_susy_pars(
   const CNE6SSM_semianalytic<T>& model
   )
{
   drbar_susy_pars.clear();
...
template <class T>
void CNE6SSM_drbar_values_writer::extract_drbar_soft_pars(
   const CNE6SSM<T>& model
   )
{
...
template <class T>
void CNE6SSM_semianalytic_drbar_values_writer::extract_drbar_soft_pars(
   const CNE6SSM_semianalytic<T>& model
   )
{
   drbar_soft_pars.clear();
...
template <class T>
void CNE6SSM_semianalytic_drbar_values_writer::extract_drbar_mixings(
   const CNE6SSM_semianalytic<T>& model
   )
{
   drbar_mixings.clear();
...
template <class T>
void CNE6SSM_slha_values_writer::extract_slha_pole_masses(
   const CNE6SSM_slha<T>& model
   )
{
...
template <class T>
void CNE6SSM_semianalytic_slha_values_writer::extract_slha_pole_masses(
   const CNE6SSM_semianalytic_slha<T>& model
   )
{
   slha_pole_masses.clear();
   slha_pole_masses_inputs = model.get_input();
...
template <class T>
void CNE6SSM_slha_values_writer::extract_slha_running_masses(
   const CNE6SSM_slha<T>& model
   )
{
...
template <class T>
void CNE6SSM_semianalytic_slha_values_writer::extract_slha_running_masses(
   const CNE6SSM_semianalytic_slha<T>& model
   )
{
   slha_running_masses.clear();
...
template <class T>
void CNE6SSM_slha_values_writer::extract_slha_susy_pars(
   const CNE6SSM_slha<T>& model
   )
{
...
template <class T>
void CNE6SSM_semianalytic_slha_values_writer::extract_slha_susy_pars(
   const CNE6SSM_semianalytic_slha<T>& model
   )
{
   slha_susy_pars.clear();
...
template <class T>
void CNE6SSM_slha_values_writer::extract_slha_soft_pars(
   const CNE6SSM_slha<T>& model
   )
{
...
template <class T>
void CNE6SSM_semianalytic_slha_values_writer::extract_slha_soft_pars(
   const CNE6SSM_semianalytic_slha<T>& model
   )
{
   slha_soft_pars.clear();
...
template <class T>
void CNE6SSM_slha_values_writer::extract_slha_pole_mixings(
   const CNE6SSM_slha<T>& model
   )
{
...
template <class T>
void CNE6SSM_semianalytic_slha_values_writer::extract_slha_pole_mixings(
   const CNE6SSM_semianalytic_slha<T>& model
   )
{
   slha_pole_mixings.clear();
...
template <class T>
void CNE6SSM_slha_values_writer::extract_slha_running_mixings(
   const CNE6SSM_slha<T>& model
   )
{
...
template <class T>
void CNE6SSM_semianalytic_slha_values_writer::extract_slha_running_mixings(
   const CNE6SSM_semianalytic_slha<T>& model
   )
{
   slha_running_mixings.clear();
...
template <class T>
void CNE6SSM_semianalytic_coefficients_writer::extract_coefficients(
   const CNE6SSM_semianalytic<T>& model
   )
{
   coefficients.clear();
