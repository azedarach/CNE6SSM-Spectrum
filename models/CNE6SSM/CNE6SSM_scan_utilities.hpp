...
template <class T>
void CNE6SSM_semianalytic_pole_mass_writer::extract_pole_masses(const CNE6SSM_semianalytic<T>& model)
{
   pole_masses.clear();
   pole_masses_scale = model.get_scale();
   pole_masses_inputs = model.get_input();
...
template <class T>
void CNE6SSM_semianalytic_drbar_values_writer::extract_drbar_masses(const CNE6SSM_semianalytic<T>& model)
{
   drbar_masses.clear();
   drbar_masses_scale = model.get_scale();
   drbar_masses_inputs = model.get_input();
...
template <class T>
void CNE6SSM_semianalytic_drbar_values_writer::extract_drbar_susy_pars(const CNE6SSM_semianalytic<T>& model)
{
   drbar_susy_pars.clear();
   drbar_susy_pars_scale = model.get_scale();
   drbar_susy_pars_inputs = model.get_input();
...
template <class T>
void CNE6SSM_semianalytic_drbar_values_writer::extract_drbar_soft_pars(const CNE6SSM_semianalytic<T>& model)
{
   drbar_soft_pars.clear();
   drbar_soft_pars_scale = model.get_scale();
   drbar_soft_pars_inputs = model.get_input();
...
template <class T>
void CNE6SSM_semianalytic_drbar_values_writer::extract_drbar_mixings(const CNE6SSM_semianalytic<T>& model)
{
   drbar_mixings.clear();
   drbar_mixings_scale = model.get_scale();
   drbar_mixings_inputs = model.get_input();
