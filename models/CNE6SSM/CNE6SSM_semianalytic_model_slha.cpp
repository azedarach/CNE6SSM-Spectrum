// ====================================================================
// Test implementation of wrapper class for semianalytic model class
// ====================================================================

/**
 * @file CNE6SSM_semianalytic_model_slha.cpp
 * @brief CNE6SSM model class wrapper for SLHA convention
 */
...
#define CLASSNAME CNE6SSM_slha<Semianalytic>
#define LOCALPHYSICAL(p) physical.p

CLASSNAME::CNE6SSM_slha(const CNE6SSM_input_parameters<Semianalytic>& input_)
   : CNE6SSM<Semianalytic>(input_)
   , physical_slha()
 ...
 */
CLASSNAME::CNE6SSM_slha(const CNE6SSM<Semianalytic>& model_)
...
{
   CNE6SSM<Semianalytic>::clear();
   physical_slha.clear();
}

void CLASSNAME::calculate_spectrum()
{
   CNE6SSM<Semianalytic>::calculate_spectrum();
   convert_to_slha();
}
...
{
   CNE6SSM<Semianalytic>::print(ostr);
