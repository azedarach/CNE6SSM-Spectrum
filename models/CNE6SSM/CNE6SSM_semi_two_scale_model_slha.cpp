...
/**
 * @file CNE6SSM_semi_two_scale_model_slha.cpp
...
#define CLASSNAME CNE6SSM_semianalytic_slha<Two_scale>
 ...
 */
CLASSNAME::CNE6SSM_semianalytic_slha(const CNE6SSM_semianalytic<Two_scale>& model_)
   : CNE6SSM_semianalytic<Two_scale>(model_)
{
   convert_to_slha();
}

CLASSNAME::~CNE6SSM_semianalytic_slha()
{
}
...
{
   CNE6SSM_semianalytic<Two_scale>::calculate_spectrum();
   convert_to_slha();
}
