...
CNE6SSM_higgs_upper_bound::CNE6SSM_higgs_upper_bound(const CNE6SSM_mass_eigenstates& model_)
   : model(model_)
   , upper_bound(0.)
...
double CNE6SSM_higgs_upper_bound::calculate_tree_level_upper_bound()
{
...
double CNE6SSM_higgs_upper_bound::calculate_one_loop_upper_bound()
{
...
double CNE6SSM_higgs_upper_bound::get_down_contribution(unsigned gen) const
{
   const double vd = model.get_vd();
   const double vu = model.get_vu();
...
double CNE6SSM_higgs_upper_bound::get_unrotated_down_contribution(unsigned gen, unsigned i, unsigned j) const
{
   double result = 0.;
...
Eigen::Matrix<double,2,2> CNE6SSM_higgs_upper_bound::get_mass_matrix_Sd(unsigned gen) const
{
   const double mq2 = model.get_mq2(gen, gen);
...
Eigen::Array<double,2,1> CNE6SSM_higgs_upper_bound::calculate_MSd2(unsigned gen) const
{
...
double CNE6SSM_higgs_upper_bound::calculate_Sin2ThetaSd(unsigned gen) const
{
   Eigen::Matrix<double,2,2> mass_matrix = get_mass_matrix_Sd(gen);
...
double CNE6SSM_higgs_upper_bound::calculate_Cos2ThetaSd(unsigned gen) const
{
   Eigen::Matrix<double,2,2> mass_matrix = get_mass_matrix_Sd(gen);
...
double CNE6SSM_higgs_upper_bound::calculate_MFd2(unsigned gen) const
{
   const double yf = model.get_Yd(gen, gen);
...
Eigen::Matrix<double,2,2> CNE6SSM_higgs_upper_bound::get_dmass_matrix_Sd_dvd(unsigned gen) const
{
   const double yf = model.get_Yd(gen, gen);
   const double Tyf = model.get_TYd(gen, gen);
   const double vd = model.get_vd();
...
Eigen::Matrix<double,2,2> CNE6SSM_higgs_upper_bound::get_dmass_matrix_Sd_dvu(unsigned gen) const
{
   const double yf = model.get_Yd(gen, gen);
   const double Lambdax = model.get_Lambdax();
   const double vu = model.get_vu();
...
Eigen::Matrix<double,2,2> CNE6SSM_higgs_upper_bound::get_d2mass_matrix_Sd_dvd_dvd(unsigned gen) const
{
   const double g1 = model.get_g1();
   const double g2 = model.get_g2();
   const double g1p = model.get_g1p();
...
Eigen::Matrix<double,2,2> CNE6SSM_higgs_upper_bound::get_d2mass_matrix_Sd_dvd_dvu(unsigned) const
{
   return Eigen::Matrix<double,2,2>::Zero();
}

Eigen::Matrix<double,2,2> CNE6SSM_higgs_upper_bound::get_d2mass_matrix_Sd_dvu_dvu(unsigned) const
{
   const double g1 = model.get_g1();
   const double g2 = model.get_g2();
   const double g1p = model.get_g1p();
...
double CNE6SSM_higgs_upper_bound::get_dV1lp_down_dvd(unsigned gen) const
{
...
double CNE6SSM_higgs_upper_bound::get_dV1lp_down_dvu(unsigned gen) const
{
...
double CNE6SSM_higgs_upper_bound::get_d2V1lp_down_dvd_dvd(unsigned gen) const
{
...
double CNE6SSM_higgs_upper_bound::get_d2V1lp_down_dvd_dvu(unsigned gen) const
{
...
double CNE6SSM_higgs_upper_bound::get_d2V1lp_down_dvu_dvu(unsigned gen) const
{
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_full_self_energy(double p, unsigned gO1, unsigned gO2) const
{
   const double vd = model.get_vd();
   const double vu = model.get_vu();
   const double vs = model.get_vs();
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_unrotated_full_self_energy(double p, unsigned gO1, unsigned gO2) const
{
   return model.self_energy_hh(p, gO1, gO2);
}

std::complex<double> CNE6SSM_higgs_upper_bound::get_self_energy(double p, unsigned gO1, unsigned gO2) const
{
   const double vd = model.get_vd();
   const double vu = model.get_vu();
   const double vs = model.get_vs();
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_unrotated_self_energy(double p, unsigned gO1, unsigned gO2) const
{
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_up_self_energy(double p, unsigned gO1, unsigned gO2) const
{
   const double vd = model.get_vd();
   const double vu = model.get_vu();
   const double vs = model.get_vs();
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_down_self_energy(double p, unsigned gO1, unsigned gO2) const
{
   const double vd = model.get_vd();
   const double vu = model.get_vu();
   const double vs = model.get_vs();
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_exotic_self_energy(double p, unsigned gO1, unsigned gO2) const
{
   const double vd = model.get_vd();
   const double vu = model.get_vu();
   const double vs = model.get_vs();
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_inert_higgs_self_energy(double p, unsigned gO1, unsigned gO2) const
{
   const double vd = model.get_vd();
   const double vu = model.get_vu();
   const double vs = model.get_vs();
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_inert_charged_higgs_self_energy(double p, unsigned gO1, unsigned gO2) const
{
   const double vd = model.get_vd();
   const double vu = model.get_vu();
   const double vs = model.get_vs();
...
double CNE6SSM_higgs_upper_bound::A0(double m) const
{
   return passarino_veltman::ReA0(m*m, Sqr(model.get_scale()));
}

double CNE6SSM_higgs_upper_bound::B0(double p, double m1, double m2) const
{
   return passarino_veltman::ReB0(p*p, m1*m1, m2*m2, Sqr(model.get_scale()));
}

double CNE6SSM_higgs_upper_bound::G0(double p, double m1, double m2) const
{
   return passarino_veltman::ReG0(p*p, m1*m1, m2*m2, Sqr(model.get_scale()));
}

std::complex<double> CNE6SSM_higgs_upper_bound::get_unrotated_up_self_energy(double p, unsigned gO1, unsigned gO2) const
{
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_unrotated_down_self_energy(double p, unsigned gO1, unsigned gO2) const
{
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_unrotated_exotic_self_energy(double p, unsigned gO1, unsigned gO2) const
{
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_unrotated_inert_higgs_self_energy(double p, unsigned gO1, unsigned gO2) const
{
...
std::complex<double> CNE6SSM_higgs_upper_bound::get_unrotated_inert_charged_higgs_self_energy(double p, unsigned gO1, unsigned gO2) const
{
