...
void write_CNE6SSM_semianalytic_inputs_list(std::ostream & filestr, std::size_t width)
{
   if (!filestr.good()) {
      ERROR("flexiblesusy::write_CNE6SSM_semianalytic_inputs_list: "
            "file stream is corrupted");
      return;
   }
...
void write_CNE6SSM_inputs(const CNE6SSM_semianalytic_input_parameters<Two_scale>& inputs, std::ostream & filestr, std::size_t width)
{
   if (!filestr.good()) {
      ERROR("flexiblesusy::write_CNE6SSM_inputs: "
            "file stream is corrupted");
...
CNE6SSM_semianalytic_pole_mass_writer::CNE6SSM_semianalytic_pole_mass_writer()
   : pole_masses()
   , pole_masses_inputs()
   , pole_masses_problems(CNE6SSM_info::particle_names)
   , pole_masses_scale(0.0)
...
void CNE6SSM_semianalytic_pole_mass_writer::write_pole_masses_comment_line(std::ostream & filestr) const
{
   if (pole_masses.empty())
      return;

   if (!filestr.good()) {
      ERROR("CNE6SSM_semianalytic_pole_mass_writer::write_pole_masses_comment_line: "
            "file stream is corrupted");
      return;
   }
...
void CNE6SSM_semianalytic_pole_mass_writer::write_pole_masses_line(std::ostream & filestr) const
{
   if (pole_masses.empty())
      return;
   ...
   for (std::size_t p = 0; p < pole_masses.size(); ++p) {
      if (!filestr.good()) {
         ERROR("CNE6SSM_semianalytic_pole_mass_writer::write_pole_masses_line: "
               "file stream is corrupted");
         break;
      }
...
CNE6SSM_semianalytic_drbar_values_writer::CNE6SSM_semianalytic_drbar_values_writer()
   : drbar_masses()
   , drbar_susy_pars()
   , drbar_soft_pars()
   , drbar_mixings()
...
void CNE6SSM_semianalytic_drbar_values_writer::write_drbar_masses_comment_line(std::ostream & filestr) const
{
   if (drbar_masses.empty())
      return;

   if (!filestr.good()) {
      ERROR("CNE6SSM_semianalytic_drbar_values_writer::write_drbar_masses_comment_line: "
            "file stream is corrupted");
      return;
   }
...
void CNE6SSM_semianalytic_drbar_values_writer::write_drbar_susy_pars_comment_line(std::ostream & filestr) const
{
   if (drbar_susy_pars.empty())
      return;

   if (!filestr.good()) {
      ERROR("CNE6SSM_semianalytic_drbar_values_writer::write_drbar_susy_pars_comment_line: "
            "file stream is corrupted");
      return;
   }
...
void CNE6SSM_semianalytic_drbar_values_writer::write_drbar_soft_pars_comment_line(std::ostream & filestr) const
{
   if (drbar_soft_pars.empty())
      return;

   if (!filestr.good()) {
      ERROR("CNE6SSM_semianalytic_drbar_values_writer::write_drbar_soft_pars_comment_line: "
            "file stream is corrupted");
      return;
   }
...
void CNE6SSM_semianalytic_drbar_values_writer::write_drbar_mixings_comment_line(std::ostream & filestr) const
{
   if (drbar_mixings.empty())
      return;

   if (!filestr.good()) {
      ERROR("CNE6SSM_semianalytic_drbar_values_writer::write_drbar_mixings_comment_line: "
            "file stream is corrupted");
      return;
   }
...
void CNE6SSM_semianalytic_drbar_values_writer::write_drbar_masses_line(std::ostream & filestr) const
{
   if (drbar_masses.empty())
      return;
   ...
   for (std::size_t p = 0; p < drbar_masses.size(); ++p) {
      if (!filestr.good()) {
         ERROR("CNE6SSM_semianalytic_drbar_values_writer::write_drbar_masses_line: "
               "file stream is corrupted");
         break;
      }
...
void CNE6SSM_semianalytic_drbar_values_writer::write_drbar_susy_pars_line(std::ostream & filestr) const
{
   if (drbar_susy_pars.empty())
      return;
   ...
   for (std::size_t p = 0; p < drbar_susy_pars.size(); ++p) {
      if (!filestr.good()) {
         ERROR("CNE6SSM_semianalytic_drbar_values_writer::write_drbar_susy_pars_line: "
               "file stream is corrupted");
         break;
      }
...
void CNE6SSM_semianalytic_drbar_values_writer::write_drbar_soft_pars_line(std::ostream & filestr) const
{
   if (drbar_soft_pars.empty())
      return;
   ...
   for (std::size_t p = 0; p < drbar_soft_pars.size(); ++p) {
      if (!filestr.good()) {
         ERROR("CNE6SSM_semianalytic_drbar_values_writer::write_drbar_soft_pars_line: "
               "file stream is corrupted");
         break;
      }
...
void CNE6SSM_semianalytic_drbar_values_writer::write_drbar_mixings_line(std::ostream & filestr) const
{
   if (drbar_mixings.empty())
      return;
   ...
   for (std::size_t p = 0; p < drbar_mixings.size(); ++p) {
      if (!filestr.good()) {
         ERROR("CNE6SSM_semianalytic_drbar_values_writer::write_drbar_mixings_line: "
               "file stream is corrupted");
         break;
      }
...
CNE6SSM_slha_values_writer::CNE6SSM_slha_values_writer()
   : slha_pole_masses()
   , slha_running_masses()
   , slha_susy_pars()
   , slha_soft_pars()
   ...
   , slha_pole_masses_problems(CNE6SSM_info::particle_names)
   , slha_running_masses_problems(CNE6SSM_info::particle_names)
   , slha_susy_pars_problems(CNE6SSM_info::particle_names)
...
CNE6SSM_semianalytic_slha_values_writer::CNE6SSM_semianalytic_slha_values_writer()
   : slha_pole_masses()
   , slha_running_masses()
   , slha_susy_pars()
   , slha_soft_pars()
...
void CNE6SSM_slha_values_writer::write_slha_pole_masses_comment_line(std::ostream & filestr) const
{
...
void CNE6SSM_semianalytic_slha_values_writer::write_slha_pole_masses_comment_line(std::ostream & filestr) const
{
   if (slha_pole_masses.empty())
      return;
...
void CNE6SSM_slha_values_writer::write_slha_running_masses_comment_line(std::ostream & filestr) const
{
...
void CNE6SSM_semianalytic_slha_values_writer::write_slha_running_masses_comment_line(std::ostream & filestr) const
{
   if (slha_running_masses.empty())
      return;
...
void CNE6SSM_slha_values_writer::write_slha_susy_pars_comment_line(std::ostream & filestr) const
{
...
void CNE6SSM_semianalytic_slha_values_writer::write_slha_susy_pars_comment_line(std::ostream & filestr) const
{
   if (slha_susy_pars.empty())
      return;
...
void CNE6SSM_slha_values_writer::write_slha_soft_pars_comment_line(std::ostream & filestr) const
{
...
void CNE6SSM_semianalytic_slha_values_writer::write_slha_soft_pars_comment_line(std::ostream & filestr) const
{
   if (slha_soft_pars.empty())
      return;
...
void CNE6SSM_slha_values_writer::write_slha_pole_mixings_comment_line(std::ostream & filestr) const
{
...
void CNE6SSM_semianalytic_slha_values_writer::write_slha_pole_mixings_comment_line(std::ostream & filestr) const
{
   if (slha_pole_mixings.empty())
      return;
...
void CNE6SSM_slha_values_writer::write_slha_running_mixings_comment_line(std::ostream & filestr) const
{
...
void CNE6SSM_semianalytic_slha_values_writer::write_slha_running_mixings_comment_line(std::ostream & filestr) const
{
   if (slha_running_mixings.empty())
      return;
...
void CNE6SSM_slha_values_writer::write_slha_pole_masses_line(std::ostream & filestr) const
{
   if (slha_pole_masses.empty())
      return;
