...
/**
 * @file CNE6SSM_semianalytic_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

#ifndef CNE6SSM_SEMIANALYTIC_SLHA_H
#define CNE6SSM_SEMIANALYTIC_SLHA_H

#include "CNE6SSM_semianalytic_model.hpp"
#include "CNE6SSM_physical.hpp"
#include "CNE6SSM_model_slha.hpp"
...
/**
 * @class CNE6SSM_slha<Semianalytic>
