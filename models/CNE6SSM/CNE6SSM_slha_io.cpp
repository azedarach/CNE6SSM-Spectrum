...
{
   void (*fill_semi_two_scale_minpar_tuple) (CNE6SSM_semianalytic_input_parameters<Two_scale>&,
                                        int, double) = &CNE6SSM_slha_io::fill_minpar_tuple;
   void (*fill_semi_two_scale_extpar_tuple) (CNE6SSM_semianalytic_input_parameters<Two_scale>&,
                                        int, double) = &CNE6SSM_slha_io::fill_extpar_tuple;
 ...
 */
void CNE6SSM_slha_io::fill_drbar_parameters(CNE6SSM_mass_eigenstates& model) const
{
 ...
 */
void CNE6SSM_slha_io::fill(CNE6SSM_mass_eigenstates& model) const
{
 ...
 */
void CNE6SSM_slha_io::fill_physical(CNE6SSM_physical& physical) const
{
   {
