...
CNE6SSM_constraint_handler<Two_scale>::CNE6SSM_constraint_handler()
...
double CNE6SSM_constraint_handler<Two_scale>::get_highest_scale() const
{
   return high_scale_constraint.get_scale();
}

double CNE6SSM_constraint_handler<Two_scale>::get_susy_scale() const
{
   return susy_scale_constraint.get_scale();
}

double CNE6SSM_constraint_handler<Two_scale>::get_lowest_scale() const
{
   return low_scale_constraint.get_scale();
}

void CNE6SSM_constraint_handler<Two_scale>::initialize_constraints(Two_scale_model* model, const QedQcd& oneset)
{
...
CNE6SSM_initial_guesser<Two_scale> CNE6SSM_constraint_handler<Two_scale>::get_initial_guesser(CNE6SSM<Two_scale>* model, const QedQcd& oneset) const
{
   CNE6SSM_initial_guesser<Two_scale> initial_guesser(model, oneset,
                                                      low_scale_constraint,
                                                      susy_scale_constraint,
                                                      high_scale_constraint);
...
void CNE6SSM_constraint_handler<Two_scale>::add_constraints_to_solver(Two_scale_model* model, RGFlow<Two_scale>& solver)
{
...
void CNE6SSM_constraint_handler<Two_scale>::set_sm_parameters(const QedQcd& oneset)
{
   low_scale_constraint.set_sm_parameters(oneset);
}

const QedQcd& CNE6SSM_constraint_handler<Two_scale>::get_sm_parameters() const
{
