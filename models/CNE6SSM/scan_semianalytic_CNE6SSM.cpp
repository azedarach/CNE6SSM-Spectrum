...
{
   std::cout <<
      "Usage: scan_semianalytic_CNE6SSM.x [options]\n"
      "Options:\n"
      "  --m12=<value>\n"
      "  --Azero=<value>\n"
      "  --TanBeta=<value>\n"
...
void set_default_parameters(CNE6SSM_semianalytic_input_parameters<Two_scale>& input)
{
   input.m12 = 3500.;
   input.TanBeta = 10.0;
   input.Azero = 1100.;
...
Eigen::Matrix<double,5,5> get_unrotated_mass_matrix_hh(CNE6SSM_mass_eigenstates model)
{
...
double get_singlet_mixing_contribution_1(const CNE6SSM_mass_eigenstates& model)
{
...
double get_singlet_mixing_contribution_2(const CNE6SSM_mass_eigenstates& model)
{
   const double vs = model.get_vs();
   const double vsb = model.get_vsb();
...
double get_singlet_mixing_contribution_3(const CNE6SSM_mass_eigenstates& model)
{
   const double vs = model.get_vs();
   const double vsb = model.get_vsb();
   const double vphi = model.get_vphi();
...
double get_singlet_mixing_contribution_4(const CNE6SSM_mass_eigenstates& model)
{
   const double vs = model.get_vs();
   const double vsb = model.get_vsb();
   const double vphi = model.get_vphi();
...
double get_singlet_mixing_contribution_5(const CNE6SSM_mass_eigenstates& model)
{
   const double vs = model.get_vs();
   const double vsb = model.get_vsb();
   const double Sigmax = model.get_Sigmax();
...
double get_singlet_mixing_contribution_6(const CNE6SSM_mass_eigenstates& model)
{
...
double get_singlet_mixing_contribution_7(const CNE6SSM_mass_eigenstates& model)
{
   const double vd = model.get_vd();
   const double vu = model.get_vu();
   const double vs = model.get_vs();
