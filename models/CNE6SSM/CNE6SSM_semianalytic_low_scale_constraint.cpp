...
double CNE6SSM_low_scale_constraint<Semianalytic>::calculate_theta_w(double alpha_em_drbar)
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
 ...
 */
void CNE6SSM_low_scale_constraint<Semianalytic>::recalculate_mw_pole()
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
