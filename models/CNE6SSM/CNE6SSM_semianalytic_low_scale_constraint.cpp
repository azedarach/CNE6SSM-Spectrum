...
CNE6SSM_low_scale_constraint<Semianalytic>::CNE6SSM_low_scale_constraint()
   ...
   , only_apply_susy_constraint(false)
{
   ckm << 1., 0., 0.,
          0., 1., 0.,
          0., 0., 1.;
...
CNE6SSM_low_scale_constraint<Semianalytic>::CNE6SSM_low_scale_constraint(
   CNE6SSM<Semianalytic>* model_, const QedQcd& oneset_)
   : Constraint<Semianalytic>()
   , model(model_)
   , oneset(oneset_)
   , new_g1(0.)
...
void CNE6SSM_low_scale_constraint<Semianalytic>::apply()
{
   assert(model && "Error: CNE6SSM_low_scale_constraint::apply():"
          " model pointer must not be zero");

   if (!only_apply_susy_constraint) {
...
const Eigen::Matrix<std::complex<double>,3,3>& CNE6SSM_low_scale_constraint<Semianalytic>::get_ckm() const
{
   return ckm;
}

const Eigen::Matrix<std::complex<double>,3,3>& CNE6SSM_low_scale_constraint<Semianalytic>::get_pmns() const
{
   return pmns;
}

double CNE6SSM_low_scale_constraint<Semianalytic>::get_scale() const
{
   return scale;
}

double CNE6SSM_low_scale_constraint<Semianalytic>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

void CNE6SSM_low_scale_constraint<Semianalytic>::set_model(Semianalytic_model* model_)
{
   model = cast_model<CNE6SSM<Semianalytic>*>(model_);
}

void CNE6SSM_low_scale_constraint<Semianalytic>::set_sm_parameters(const QedQcd& oneset_)
{
   oneset = oneset_;
}

const QedQcd& CNE6SSM_low_scale_constraint<Semianalytic>::get_sm_parameters() const
{
   return oneset;
}

void CNE6SSM_low_scale_constraint<Semianalytic>::apply_susy_constraint_only(bool flag)
{
   only_apply_susy_constraint = flag;
}

void CNE6SSM_low_scale_constraint<Semianalytic>::clear()
{
   scale = 0.;
   initial_scale_guess = 0.;
   model = NULL;
...
void CNE6SSM_low_scale_constraint<Semianalytic>::initialize()
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
...
void CNE6SSM_low_scale_constraint<Semianalytic>::update_scale()
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
...
void CNE6SSM_low_scale_constraint<Semianalytic>::calculate_threshold_corrections()
{
   ...
   EDRbar = e_drbar;
   // TODO:: this guess must be improved
   ThetaWDRbar = ArcSin(Sqrt(0.231)); //1.0 - Sqr(MWDRbar) / Sqr(MZDRbar)));
}

void CNE6SSM_low_scale_constraint<Semianalytic>::calculate_DRbar_gauge_couplings()
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
...
double CNE6SSM_low_scale_constraint<Semianalytic>::calculate_delta_alpha_em(double alphaEm) const
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
...
double CNE6SSM_low_scale_constraint<Semianalytic>::calculate_delta_alpha_s(double alphaS) const
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
...
void CNE6SSM_low_scale_constraint<Semianalytic>::calculate_DRbar_yukawa_couplings()
{
   calculate_Yu_DRbar();
   calculate_Yd_DRbar();
   calculate_Ye_DRbar();
...
void CNE6SSM_low_scale_constraint<Semianalytic>::calculate_Yu_DRbar()
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
...
void CNE6SSM_low_scale_constraint<Semianalytic>::calculate_Yd_DRbar()
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
...
void CNE6SSM_low_scale_constraint<Semianalytic>::calculate_Ye_DRbar()
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
...
void CNE6SSM_low_scale_constraint<Semianalytic>::calculate_MNeutrino_DRbar()
{
   assert(model && "CNE6SSM_low_scale_constraint<Semianalytic>::"
