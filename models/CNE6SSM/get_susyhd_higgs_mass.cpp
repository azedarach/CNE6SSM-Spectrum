...
CNE6SSM_semianalytic_input_parameters<Two_scale> read_inputs_from_datapoint(const std::string& susy_pars_line,
                                                    const std::map<std::string,std::size_t>& columns)
{
   CNE6SSM_semianalytic_input_parameters<Two_scale> inputs;
...
CNE6SSM_mass_eigenstates initialize_model_from_datapoint(
...
SUSYHD::SUSYHD_input_parameters match_to_MSSM(CNE6SSM_mass_eigenstates model, bool use_MSSM_mA)
{
