...
/**
 * @file CNE6SSM_semi_two_scale_model.hpp
...
#ifndef CNE6SSM_SEMI_TWO_SCALE_MODEL_H
#define CNE6SSM_SEMI_TWO_SCALE_MODEL_H

#include "CNE6SSM_semi_model.hpp"
...
class Two_scale;
/**
 * @class CNE6SSM_semianalytic<Two_scale>
 * @brief model class with routines for determining masses and mixings and EWSB
 */
template<>
class CNE6SSM_semianalytic<Two_scale> : public Two_scale_model, public CNE6SSM_mass_eigenstates {
public:
   explicit CNE6SSM_semianalytic(const CNE6SSM_semianalytic_input_parameters<Two_scale>& input_ = CNE6SSM_semianalytic_input_parameters<Two_scale>());
   virtual ~CNE6SSM_semianalytic();
   ...
   const CNE6SSM_semianalytic_input_parameters<Two_scale>& get_input() const;
   CNE6SSM_semianalytic_input_parameters<Two_scale>& get_input();
   void set_input_parameters(const CNE6SSM_semianalytic_input_parameters<Two_scale>&);
