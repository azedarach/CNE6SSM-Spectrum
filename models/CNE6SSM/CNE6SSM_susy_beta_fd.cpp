 ...
 */
Eigen::Matrix<double,3,2> CNE6SSM_susy_parameters::calc_beta_fd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,2> CNE6SSM_susy_parameters::calc_beta_fd_two_loop(const Susy_traces& susy_traces) const
{
