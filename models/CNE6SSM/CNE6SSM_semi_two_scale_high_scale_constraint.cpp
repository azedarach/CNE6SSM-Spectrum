...
CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::CNE6SSM_semianalytic_high_scale_constraint()
...
CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::CNE6SSM_semianalytic_high_scale_constraint(CNE6SSM_semianalytic<Two_scale>* model_)
   : Constraint<Two_scale>()
   , model(model_)
{
   initialize();
...
void CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::apply()
{
   assert(model && "Error: CNE6SSM_semianalytic_high_scale_constraint::apply():"
...
double CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::get_initial_scale_guess() const
{
   return initial_scale_guess;
}

const CNE6SSM_semianalytic_input_parameters<Two_scale>& CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::get_input_parameters() const
{
   return model->get_input();
}

CNE6SSM_semianalytic<Two_scale>* CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::get_model() const
{
   return model;
}

void CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::set_model(Two_scale_model* model_)
{
   model = cast_model<CNE6SSM_semianalytic<Two_scale>*>(model_);
}

void CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::set_initial_scale_guess(double s)
{
   initial_scale_guess = s;
   scale = initial_scale_guess;
}

void CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::set_scale(double s)
{
   scale = s;
}

void CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::clear()
{
   scale = 0.;
   initial_scale_guess = 0.;
   model = NULL;
...
void CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::initialize()
{
   assert(model && "CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::"
...
void CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::update_scale()
{
   assert(model && "CNE6SSM_semianalytic_high_scale_constraint<Two_scale>::"
   ...
   if (errno == ERANGE) {
#ifdef ENABLE_VERBOSE
      ERROR("CNE6SSM_semianalytic_high_scale_constraint<Two_scale>: Overflow error"
