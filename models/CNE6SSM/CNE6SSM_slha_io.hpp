...
template <class T>
struct CNE6SSM_semianalytic_input_parameters;

class Two_scale;
class Spectrum_generator_settings;

struct CNE6SSM_scales {
   CNE6SSM_scales() : HighScale(0.), SUSYScale(0.), LowScale(0.) {}
...
public:
   ...
   void fill(CNE6SSM_semianalytic_input_parameters<Two_scale>&) const;
   template <class T> void fill(CNE6SSM_slha<T>&) const;
   template <class T> void fill(CNE6SSM_semianalytic_slha<T>&) const;
   ...
   template <class T> void set_spectrum(const CNE6SSM_semianalytic_slha<T>&);
   template <class T> void set_spectrum(const CNE6SSM_semianalytic<T>&);
   ...
   static void fill_minpar_tuple(CNE6SSM_semianalytic_input_parameters<Two_scale>&, int, double);
   static void fill_extpar_tuple(CNE6SSM_semianalytic_input_parameters<Two_scale>&, int, double);
   static void fill_flexiblesusy_tuple(Spectrum_generator_settings&, int, double);

   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const CNE6SSM_slha<T>&, const QedQcd&, const CNE6SSM_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const CNE6SSM_slha<T>&, const QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const CNE6SSM_slha<T>&, const QedQcd&, const CNE6SSM_scales&);

   template <class T>
   static void fill_slhaea(SLHAea::Coll&, const CNE6SSM_semianalytic_slha<T>&, const QedQcd&, const CNE6SSM_scales&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const CNE6SSM_semianalytic_slha<T>&, const QedQcd&);

   template <class T>
   static SLHAea::Coll fill_slhaea(const CNE6SSM_semianalytic_slha<T>&, const QedQcd&, const CNE6SSM_scales&);
...
private:
   ...
   template <class T> void set_model_parameters(const CNE6SSM_semianalytic_slha<T>&);
   void set_ckm(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   void set_pmns(const Eigen::Matrix<std::complex<double>,3,3>&, double);
   double read_scale() const;
   template <class T> void fill_drbar_parameters(CNE6SSM_slha<T>&) const;
   template <class T> void fill_physical(CNE6SSM_slha<T>&) const;
   template <class T> void fill_drbar_parameters(CNE6SSM_semianalytic_slha<T>&) const;
   template <class T> void fill_physical(CNE6SSM_semianalytic_slha<T>&) const;
};
 ...
 */
template <class T>
void CNE6SSM_slha_io::fill_drbar_parameters(CNE6SSM_slha<T>& model) const
{
 ...
 */
template <class T>
void CNE6SSM_slha_io::fill_drbar_parameters(CNE6SSM_semianalytic_slha<T>& model) const
{
   model.set_g1(slha_io.read_entry("gauge", 1) * 1.2909944487358056);
   model.set_g2(slha_io.read_entry("gauge", 2));
   model.set_g3(slha_io.read_entry("gauge", 3));
 ...
 */
template <class T>
void CNE6SSM_slha_io::fill_physical(CNE6SSM_slha<T>& model) const
{
   {
      DEFINE_PARAMETER(ZD);
 ...
 */
template <class T>
void CNE6SSM_slha_io::fill_physical(CNE6SSM_semianalytic_slha<T>& model) const
{
   {
      DEFINE_PARAMETER(ZD);
      slha_io.read_block("DSQMIX", ZD);
...
template <class T>
void CNE6SSM_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const CNE6SSM_slha<T>& model,
   const QedQcd& qedqcd, const CNE6SSM_scales& scales)
{
   CNE6SSM_slha_io slha_io;
   const CNE6SSM_input_parameters<T>& input = model.get_input();
...
template <class T>
void CNE6SSM_slha_io::fill_slhaea(
   SLHAea::Coll& slhaea, const CNE6SSM_semianalytic_slha<T>& model,
   const QedQcd& qedqcd, const CNE6SSM_scales& scales)
{
   CNE6SSM_slha_io slha_io;
   const CNE6SSM_semianalytic_input_parameters<T>& input = model.get_input();
   const Problems<CNE6SSM_info::NUMBER_OF_PARTICLES>& problems
      = model.get_problems();
   const bool error = problems.have_problem();
...
template <class T>
SLHAea::Coll CNE6SSM_slha_io::fill_slhaea(
   const CNE6SSM_slha<T>& model, const QedQcd& qedqcd)
{
...
template <class T>
SLHAea::Coll CNE6SSM_slha_io::fill_slhaea(
   const CNE6SSM_semianalytic_slha<T>& model, const QedQcd& qedqcd)
{
   CNE6SSM_scales scales;
...
SLHAea::Coll CNE6SSM_slha_io::fill_slhaea(
   const CNE6SSM_slha<T>& model, const QedQcd& qedqcd,
   const CNE6SSM_scales& scales)
{
   SLHAea::Coll slhaea;
   CNE6SSM_slha_io::fill_slhaea(slhaea, model, qedqcd, scales);
 ...
 */
template <class T>
void CNE6SSM_slha_io::set_model_parameters(const CNE6SSM_slha<T>& model)
{
   {
 ...
 */
template <class T>
void CNE6SSM_slha_io::set_model_parameters(const CNE6SSM_semianalytic_slha<T>& model)
{
   {
      std::ostringstream block;
      block << "Block gauge Q= " << FORMAT_SCALE(model.get_scale()) << '\n'
...
void CNE6SSM_slha_io::set_extra(
   const CNE6SSM_slha<T>& model, const CNE6SSM_scales& scales)
{
...
template <class T>
void CNE6SSM_slha_io::set_extra(
   const CNE6SSM_semianalytic_slha<T>& model, const CNE6SSM_scales& scales)
{
   const CNE6SSM_physical physical(model.get_physical_slha());
...
{
   const CNE6SSM_slha<T> model_slha(model);
 ...
 */
template <class T>
void CNE6SSM_slha_io::set_spectrum(const CNE6SSM_semianalytic<T>& model)
{
   const CNE6SSM_semianalytic_slha<T> model_slha(model);
   set_spectrum(model_slha);
}
