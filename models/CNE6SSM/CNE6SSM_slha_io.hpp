...
private:
   ...
   template <class T> void set_mass(const CNE6SSM<T>&);
   template <class T> void set_mixing_matrices(const CNE6SSM<T>&);
...
template <class T>
void CNE6SSM_slha_io::set_mass(const CNE6SSM<T>& model)
{
...
template <class T>
void CNE6SSM_slha_io::set_mixing_matrices(const CNE6SSM<T>& model)
{
