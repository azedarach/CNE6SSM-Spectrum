...
/**
 * @file CNE6SSM_semi_two_scale_model_slha.hpp
 * @brief contains wrapper class for model class in SLHA convention
 */

#ifndef CNE6SSM_SEMI_TWO_SCALE_SLHA_H
#define CNE6SSM_SEMI_TWO_SCALE_SLHA_H

#include "CNE6SSM_semi_two_scale_model.hpp"
#include "CNE6SSM_physical.hpp"
#include "CNE6SSM_semi_model_slha.hpp"
...
/**
 * @class CNE6SSM_semianalytic_slha<Two_scale>
 * @brief model class wrapper in SLHA convention
 */

template<>
class CNE6SSM_semianalytic_slha<Two_scale> : public CNE6SSM_semianalytic<Two_scale> {
public:
   explicit CNE6SSM_semianalytic_slha(const CNE6SSM_semianalytic_input_parameters<Two_scale>& input_ = CNE6SSM_semianalytic_input_parameters<Two_scale>());
   explicit CNE6SSM_semianalytic_slha(const CNE6SSM_semianalytic<Two_scale>&);
   virtual ~CNE6SSM_semianalytic_slha();
   ...
   CNE6SSM_physical& get_drbar_slha(); ///< return DR-bar masses to SLHA convention
