...
#ifndef lowNE6SSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H
#define lowNE6SSM_TWO_SCALE_LOW_SCALE_CONSTRAINT_H

#include "lowNE6SSM_low_scale_constraint.hpp"
...
template<>
class lowNE6SSM_low_scale_constraint<Two_scale> : public Constraint<Two_scale> {
public:
   lowNE6SSM_low_scale_constraint();
   lowNE6SSM_low_scale_constraint(const lowNE6SSM_input_parameters&, const QedQcd&);
   virtual ~lowNE6SSM_low_scale_constraint();
   virtual void apply();
