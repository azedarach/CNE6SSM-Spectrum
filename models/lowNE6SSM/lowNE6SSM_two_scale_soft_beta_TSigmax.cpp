...
// File generated at Sun 21 Sep 2014 21:50:26
 ...
 */
double lowNE6SSM_soft_parameters::calc_beta_TSigmax_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double lowNE6SSM_soft_parameters::calc_beta_TSigmax_two_loop(const Soft_traces& soft_traces) const
{
   const auto QS = INPUT(QS);
