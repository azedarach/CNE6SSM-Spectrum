...
// ====================================================================
/**
 * @file lowNE6SSM_two_scale_model.hpp
...
#ifndef lowNE6SSM_TWO_SCALE_H
#define lowNE6SSM_TWO_SCALE_H

#include "lowNE6SSM_model.hpp"
#include "lowNE6SSM_two_scale_soft_parameters.hpp"
#include "lowNE6SSM_physical.hpp"
...
class Two_scale;
/**
 * @class lowNE6SSM<Two_scale>
 * @brief model class with routines for determing masses and mixinga and EWSB
 */
template<>
class lowNE6SSM<Two_scale> : public Two_scale_model, public lowNE6SSM_soft_parameters {
public:
   explicit lowNE6SSM(const lowNE6SSM_input_parameters& input_ = lowNE6SSM_input_parameters());
   virtual ~lowNE6SSM();
   ...
   void set_physical(const lowNE6SSM_physical&);
   double get_ewsb_iteration_precision() const;
   double get_ewsb_loop_order() const;
   const lowNE6SSM_physical& get_physical() const;
   lowNE6SSM_physical& get_physical();
   const Problems<lowNE6SSM_info::NUMBER_OF_PARTICLES>& get_problems() const;
   Problems<lowNE6SSM_info::NUMBER_OF_PARTICLES>& get_problems();
...
private:
   ...
   struct Thread {
      typedef void(lowNE6SSM<Two_scale>::*Memfun_t)();
      lowNE6SSM<Two_scale>* model;
      Memfun_t fun;

      Thread(lowNE6SSM<Two_scale>* model_, Memfun_t fun_)
   ...
   lowNE6SSM_physical physical; ///< contains the pole masses and mixings
   Problems<lowNE6SSM_info::NUMBER_OF_PARTICLES> problems;
...
std::ostream& operator<<(std::ostream&, const lowNE6SSM<Two_scale>&);
