...
#ifndef lowNE6SSM_TWO_SCALE_susy_parameters_H
#define lowNE6SSM_TWO_SCALE_susy_parameters_H
...
class lowNE6SSM_susy_parameters : public Beta_function {
public:
   explicit lowNE6SSM_susy_parameters(const lowNE6SSM_input_parameters& input_ = lowNE6SSM_input_parameters());
   lowNE6SSM_susy_parameters(double scale_, double loops_, double thresholds_, const lowNE6SSM_input_parameters& input_, const Eigen::Matrix<double,3,3>& Yd_, const Eigen::Matrix<double,3,2>& hE_
   ...
   virtual ~lowNE6SSM_susy_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual const Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);
   const lowNE6SSM_input_parameters& get_input() const;
   void set_input_parameters(const lowNE6SSM_input_parameters&);

   lowNE6SSM_susy_parameters calc_beta() const;
   virtual void clear();
...
protected:
   ...
   lowNE6SSM_input_parameters input;
...
std::ostream& operator<<(std::ostream&, const lowNE6SSM_susy_parameters&);
