...
// File generated at Sun 21 Sep 2014 21:51:14

#ifndef lowNE6SSM_INPUT_PARAMETERS_H
#define lowNE6SSM_INPUT_PARAMETERS_H
...
struct lowNE6SSM_input_parameters {
   ...
   lowNE6SSM_input_parameters()
      : TanBeta(0), muPrimeInput(0), BmuPrimeInput(0), ssumInput(0), QS(0),
   TanTheta(0), hEInput(Eigen::Matrix<double,3,2>::Zero()), SigmaLInput(0),
   KappaPrInput(0), SigmaxInput(0), gDInput(Eigen::Matrix<double,3,3>::Zero()),
   KappaInput(Eigen::Matrix<double,3,3>::Zero()), Lambda12Input(Eigen::Matrix<
   double,2,2>::Zero()), LambdaxInput(0), fuInput(Eigen::Matrix<double,3,2>
   ::Zero()), fdInput(Eigen::Matrix<double,3,2>::Zero()), MuPhiInput(0),
   XiFInput(0), g1pInput(0), vphiInput(0), TYdInput(Eigen::Matrix<double,3,3>
