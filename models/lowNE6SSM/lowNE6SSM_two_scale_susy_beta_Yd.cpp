 ...
 */
Eigen::Matrix<double,3,3> lowNE6SSM_susy_parameters::calc_beta_Yd_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> lowNE6SSM_susy_parameters::calc_beta_Yd_two_loop(const Susy_traces& susy_traces) const
{
