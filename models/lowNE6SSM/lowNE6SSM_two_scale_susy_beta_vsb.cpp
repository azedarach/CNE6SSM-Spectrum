 ...
 */
double lowNE6SSM_susy_parameters::calc_beta_vsb_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
double lowNE6SSM_susy_parameters::calc_beta_vsb_two_loop(const Susy_traces& susy_traces) const
{
   const auto QS = INPUT(QS);
