...
// File generated at Sun 21 Sep 2014 21:44:35
 ...
 */
Eigen::Matrix<double,3,3> lowNE6SSM_susy_parameters::calc_beta_Kappa_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,3,3> lowNE6SSM_susy_parameters::calc_beta_Kappa_two_loop(const Susy_traces& susy_traces) const
{
   const auto QS = INPUT(QS);
