...
#ifndef lowNE6SSM_TWO_SCALE_soft_parameters_H
#define lowNE6SSM_TWO_SCALE_soft_parameters_H
...
class lowNE6SSM_soft_parameters : public lowNE6SSM_susy_parameters {
public:
   explicit lowNE6SSM_soft_parameters(const lowNE6SSM_input_parameters& input_ = lowNE6SSM_input_parameters());
   lowNE6SSM_soft_parameters(const lowNE6SSM_susy_parameters& , const Eigen::Matrix<double,3,3>& TYd_, const Eigen::Matrix<double,3,2>&
   ...
   virtual ~lowNE6SSM_soft_parameters() {}
   virtual Eigen::ArrayXd beta() const;
   virtual const Eigen::ArrayXd get() const;
   virtual void print(std::ostream&) const;
   virtual void set(const Eigen::ArrayXd&);

   lowNE6SSM_soft_parameters calc_beta() const;
   virtual void clear();
...
std::ostream& operator<<(std::ostream&, const lowNE6SSM_soft_parameters&);
