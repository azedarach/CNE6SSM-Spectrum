...
// File generated at Sun 21 Sep 2014 21:44:36
 ...
 */
Eigen::Matrix<double,2,2> lowNE6SSM_susy_parameters::calc_beta_Lambda12_one_loop(const Susy_traces& susy_traces) const
{
 ...
 */
Eigen::Matrix<double,2,2> lowNE6SSM_susy_parameters::calc_beta_Lambda12_two_loop(const Susy_traces& susy_traces) const
{
   const auto QS = INPUT(QS);
