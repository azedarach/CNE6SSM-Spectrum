 ...
 */
double lowNE6SSM_soft_parameters::calc_beta_mphi2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double lowNE6SSM_soft_parameters::calc_beta_mphi2_two_loop(const Soft_traces& soft_traces) const
{
