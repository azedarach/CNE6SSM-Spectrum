...
// File generated at Sun 21 Sep 2014 21:44:31
...
#define CLASSNAME lowNE6SSM_susy_parameters
#define INPUT(parameter) input.parameter
#define TRACE_STRUCT susy_traces

lowNE6SSM_susy_parameters::lowNE6SSM_susy_parameters(const lowNE6SSM_input_parameters& input_)
   : Beta_function()
...
lowNE6SSM_susy_parameters::lowNE6SSM_susy_parameters(
   double scale_, double loops_, double thresholds_,
   const lowNE6SSM_input_parameters& input_
...
Eigen::ArrayXd lowNE6SSM_susy_parameters::beta() const
{
   return calc_beta().get();
}

lowNE6SSM_susy_parameters lowNE6SSM_susy_parameters::calc_beta() const
{
   ...
   return lowNE6SSM_susy_parameters(get_scale(), get_loops(), get_thresholds(), input,
...
void lowNE6SSM_susy_parameters::clear()
{
   reset();
...
const Eigen::ArrayXd lowNE6SSM_susy_parameters::get() const
{
...
void lowNE6SSM_susy_parameters::print(std::ostream& ostr) const
{
...
void lowNE6SSM_susy_parameters::set(const Eigen::ArrayXd& v)
{
   Yd(0,0) = v(0);
   Yd(0,1) = v(1);
   Yd(0,2) = v(2);
...
const lowNE6SSM_input_parameters& lowNE6SSM_susy_parameters::get_input() const
{
   return input;
}

void lowNE6SSM_susy_parameters::set_input_parameters(const lowNE6SSM_input_parameters& input_)
{
   input = input_;
}

void lowNE6SSM_susy_parameters::calc_susy_traces(Susy_traces& susy_traces) const
{
...
std::ostream& operator<<(std::ostream& ostr, const lowNE6SSM_susy_parameters& susy_pars)
{
