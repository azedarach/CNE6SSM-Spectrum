...
// File generated at Sun 21 Sep 2014 21:50:17

#include "lowNE6SSM_two_scale_soft_parameters.hpp"
...
lowNE6SSM_soft_parameters::lowNE6SSM_soft_parameters(const lowNE6SSM_input_parameters& input_)
   : lowNE6SSM_susy_parameters(input_)
...
lowNE6SSM_soft_parameters::lowNE6SSM_soft_parameters(
   const lowNE6SSM_susy_parameters& susy_model
   ...
   : lowNE6SSM_susy_parameters(susy_model)
...
Eigen::ArrayXd lowNE6SSM_soft_parameters::beta() const
{
   return calc_beta().get();
}

lowNE6SSM_soft_parameters lowNE6SSM_soft_parameters::calc_beta() const
{
...
const Eigen::ArrayXd lowNE6SSM_soft_parameters::get() const
{
   Eigen::ArrayXd pars(lowNE6SSM_susy_parameters::get());
...
void lowNE6SSM_soft_parameters::print(std::ostream& ostr) const
{
   lowNE6SSM_susy_parameters::print(ostr);
...
void lowNE6SSM_soft_parameters::set(const Eigen::ArrayXd& v)
{
   lowNE6SSM_susy_parameters::set(v);
...
void lowNE6SSM_soft_parameters::calc_soft_traces(Soft_traces& soft_traces) const
{
...
std::ostream& operator<<(std::ostream& ostr, const lowNE6SSM_soft_parameters& soft_pars)
{
