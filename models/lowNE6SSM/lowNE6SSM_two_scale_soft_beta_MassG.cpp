 ...
 */
double lowNE6SSM_soft_parameters::calc_beta_MassG_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double lowNE6SSM_soft_parameters::calc_beta_MassG_two_loop(const Soft_traces& soft_traces) const
{
