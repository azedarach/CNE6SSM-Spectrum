...
#ifndef lowNE6SSM_SLHA_IO_H
#define lowNE6SSM_SLHA_IO_H
...
struct lowNE6SSM_input_parameters;
class Spectrum_generator_settings;

class lowNE6SSM_slha_io {
public:
   lowNE6SSM_slha_io();
   ~lowNE6SSM_slha_io() {}
   ...
   void fill(lowNE6SSM_input_parameters&) const;
   template <class T> void fill(lowNE6SSM<T>&) const;
   void fill(Spectrum_generator_settings&) const;
   double get_input_scale() const;
   double get_parameter_output_scale() const;
   void read_from_file(const std::string&);
   void set_extpar(const lowNE6SSM_input_parameters&);
   void set_minpar(const lowNE6SSM_input_parameters&);
   void set_sminputs(const softsusy::QedQcd&);
   template <class T> void set_spectrum(const lowNE6SSM<T>&);
   void set_spinfo(const Problems<lowNE6SSM_info::NUMBER_OF_PARTICLES>&);
   void write_to_file(const std::string&);
   void write_to_stream(std::ostream& ostr = std::cout) { slha_io.write_to_stream(ostr); }

   static void fill_minpar_tuple(lowNE6SSM_input_parameters&, int, double);
   static void fill_extpar_tuple(lowNE6SSM_input_parameters&, int, double);
...
private:
   ...
   template <class T> void set_mass(const lowNE6SSM<T>&);
   template <class T> void set_mixing_matrices(const lowNE6SSM<T>&);
   template <class T> void set_model_parameters(const lowNE6SSM<T>&);
   double read_scale() const;
   template <class T> void fill_drbar_parameters(lowNE6SSM<T>&) const;
   template <class T> void fill_physical(lowNE6SSM<T>&) const;
};
 ...
 */
template <class T>
void lowNE6SSM_slha_io::fill(lowNE6SSM<T>& model) const
{
 ...
 */
template <class T>
void lowNE6SSM_slha_io::fill_drbar_parameters(lowNE6SSM<T>& model) const
{
 ...
 */
template <class T>
void lowNE6SSM_slha_io::fill_physical(lowNE6SSM<T>& model) const
{
   {
      DEFINE_PARAMETER(ZD);
...
template <class T>
void lowNE6SSM_slha_io::set_mass(const lowNE6SSM<T>& model)
{
...
template <class T>
void lowNE6SSM_slha_io::set_mixing_matrices(const lowNE6SSM<T>& model)
{
...
template <class T>
void lowNE6SSM_slha_io::set_model_parameters(const lowNE6SSM<T>& model)
{
   {
...
template <class T>
void lowNE6SSM_slha_io::set_spectrum(const lowNE6SSM<T>& model)
{
