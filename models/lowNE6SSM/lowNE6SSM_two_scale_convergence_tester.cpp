...
lowNE6SSM_convergence_tester<Two_scale>::lowNE6SSM_convergence_tester(lowNE6SSM<Two_scale>* model, double accuracy_goal)
   : Convergence_tester_DRbar<lowNE6SSM<Two_scale> >(model, accuracy_goal)
{
}

lowNE6SSM_convergence_tester<Two_scale>::~lowNE6SSM_convergence_tester()
{
}
