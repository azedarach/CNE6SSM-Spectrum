...
lowNE6SSM_physical::lowNE6SSM_physical()
   :
...
void lowNE6SSM_physical::print(std::ostream& ostr) const
{
   ostr << "----------------------------------------\n"
...
std::ostream& operator<<(std::ostream& ostr, const lowNE6SSM_physical& phys_pars)
{
