...
// File generated at Sun 21 Sep 2014 21:50:59
 ...
 */
double lowNE6SSM_soft_parameters::calc_beta_msbar2_one_loop(const Soft_traces& soft_traces) const
{
 ...
 */
double lowNE6SSM_soft_parameters::calc_beta_msbar2_two_loop(const Soft_traces& soft_traces) const
{
   const auto QS = INPUT(QS);
