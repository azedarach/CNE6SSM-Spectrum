 ...
 *
 * Contains the definition of the CMSSM mass eigenstates class methods
...
#ifdef ENABLE_THREADS
   std::mutex CMSSM_mass_eigenstates::mtx_fortran;
...
CMSSM_mass_eigenstates::CMSSM_mass_eigenstates()
...
void CMSSM_mass_eigenstates::do_calculate_sm_pole_masses(bool flag)
{
   calculate_sm_pole_masses = flag;
}

bool CMSSM_mass_eigenstates::do_calculate_sm_pole_masses() const
{
   return calculate_sm_pole_masses;
}

void CMSSM_mass_eigenstates::do_force_output(bool flag)
{
   force_output = flag;
}

bool CMSSM_mass_eigenstates::do_force_output() const
{
   return force_output;
}

void CMSSM_mass_eigenstates::set_two_loop_corrections(const Two_loop_corrections& two_loop_corrections_)
{
   two_loop_corrections = two_loop_corrections_;
}

void CMSSM_mass_eigenstates::set_number_of_mass_iterations(std::size_t iterations)
{
   number_of_mass_iterations = iterations;
}

void CMSSM_mass_eigenstates::set_diagonalization_precision(double precision)
{
   diagonalization_precision = precision;
}

double CMSSM_mass_eigenstates::get_diagonalization_precision() const
{
   return diagonalization_precision;
}

void CMSSM_mass_eigenstates::set_pole_mass_loop_order(unsigned loop_order)
{
   pole_mass_loop_order = loop_order;
}

const CMSSM_physical& CMSSM_mass_eigenstates::get_physical() const
{
   return physical;
}

CMSSM_physical& CMSSM_mass_eigenstates::get_physical()
{
   return physical;
}

void CMSSM_mass_eigenstates::set_physical(const CMSSM_physical& physical_)
{
   physical = physical_;
}

const Problems<CMSSM_info::NUMBER_OF_PARTICLES>& CMSSM_mass_eigenstates::get_problems() const
{
   return problems;
}

Problems<CMSSM_info::NUMBER_OF_PARTICLES>& CMSSM_mass_eigenstates::get_problems()
{
   return problems;
}

int CMSSM_mass_eigenstates::solve_ewsb_tree_level_via_soft_higgs_masses()
{
   int error = 0;
...
const Eigen::Array<double,2,1> CMSSM_mass_eigenstates::get_ewsb_tree_level_soft_masses()
{
...
void CMSSM_mass_eigenstates::print(std::ostream& ostr) const
{
...
double CMSSM_mass_eigenstates::A0(double m) const
{
   return passarino_veltman::ReA0(m*m, Sqr(get_scale()));
}

double CMSSM_mass_eigenstates::B0(double p, double m1, double m2) const
{
   return passarino_veltman::ReB0(p*p, m1*m1, m2*m2, Sqr(get_scale()));
}

double CMSSM_mass_eigenstates::B1(double p, double m1, double m2) const
{
   return passarino_veltman::ReB1(p*p, m1*m1, m2*m2, Sqr(get_scale()));
}

double CMSSM_mass_eigenstates::B00(double p, double m1, double m2) const
{
   return passarino_veltman::ReB00(p*p, m1*m1, m2*m2, Sqr(get_scale()));
}

double CMSSM_mass_eigenstates::B22(double p, double m1, double m2) const
{
   return passarino_veltman::ReB22(p*p, m1*m1, m2*m2, Sqr(get_scale()));
}

double CMSSM_mass_eigenstates::H0(double p, double m1, double m2) const
{
   return passarino_veltman::ReH0(p*p, m1*m1, m2*m2, Sqr(get_scale()));
}

double CMSSM_mass_eigenstates::F0(double p, double m1, double m2) const
{
   return passarino_veltman::ReF0(p*p, m1*m1, m2*m2, Sqr(get_scale()));
}

double CMSSM_mass_eigenstates::G0(double p, double m1, double m2) const
{
 ...
 */
void CMSSM_mass_eigenstates::calculate_DRbar_masses()
{
   const auto old_mHd2 = mHd2;
   const auto old_mHu2 = mHu2;
 ...
 */
void CMSSM_mass_eigenstates::calculate_DRbar_parameters()
{
 ...
 */
void CMSSM_mass_eigenstates::calculate_pole_masses()
{
#ifdef ENABLE_THREADS
   thread_exception = 0;

   std::thread thread_MAh(Thread(this, &CMSSM_mass_eigenstates::calculate_MAh_pole));
   std::thread thread_MCha(Thread(this, &CMSSM_mass_eigenstates::calculate_MCha_pole));
   std::thread thread_MChi(Thread(this, &CMSSM_mass_eigenstates::calculate_MChi_pole));
   std::thread thread_MGlu(Thread(this, &CMSSM_mass_eigenstates::calculate_MGlu_pole));
   std::thread thread_Mhh(Thread(this, &CMSSM_mass_eigenstates::calculate_Mhh_pole));
   std::thread thread_MHpm(Thread(this, &CMSSM_mass_eigenstates::calculate_MHpm_pole));
   std::thread thread_MSd(Thread(this, &CMSSM_mass_eigenstates::calculate_MSd_pole));
   std::thread thread_MSe(Thread(this, &CMSSM_mass_eigenstates::calculate_MSe_pole));
   std::thread thread_MSu(Thread(this, &CMSSM_mass_eigenstates::calculate_MSu_pole));
   std::thread thread_MSv(Thread(this, &CMSSM_mass_eigenstates::calculate_MSv_pole));

   if (calculate_sm_pole_masses) {
      std::thread thread_MVG(Thread(this, &CMSSM_mass_eigenstates::calculate_MVG_pole));
      std::thread thread_MFv(Thread(this, &CMSSM_mass_eigenstates::calculate_MFv_pole));
      std::thread thread_MVP(Thread(this, &CMSSM_mass_eigenstates::calculate_MVP_pole));
      std::thread thread_MVZ(Thread(this, &CMSSM_mass_eigenstates::calculate_MVZ_pole));
      std::thread thread_MFe(Thread(this, &CMSSM_mass_eigenstates::calculate_MFe_pole));
      std::thread thread_MFd(Thread(this, &CMSSM_mass_eigenstates::calculate_MFd_pole));
      std::thread thread_MFu(Thread(this, &CMSSM_mass_eigenstates::calculate_MFu_pole));
      std::thread thread_MVWm(Thread(this, &CMSSM_mass_eigenstates::calculate_MVWm_pole));
      thread_MVG.join();
      thread_MFv.join();
      thread_MVP.join();
      thread_MVZ.join();
...
void CMSSM_mass_eigenstates::copy_DRbar_masses_to_pole_masses()
{
   PHYSICAL(MVG) = MVG;
   PHYSICAL(MGlu) = MGlu;
   PHYSICAL(MFv) = MFv;
 ...
 */
void CMSSM_mass_eigenstates::reorder_DRbar_masses()
{
 ...
 * in the Models directory of your SARAH distribution for example)
 */
void CMSSM_mass_eigenstates::reorder_pole_masses()
{
...
void CMSSM_mass_eigenstates::clear_DRbar_parameters()
{
   MVG = 0.;
   MGlu = 0.;
...
void CMSSM_mass_eigenstates::clear()
{
...
Eigen::Array<double,1,1> CMSSM_mass_eigenstates::get_MChargedHiggs() const
{
...
Eigen::Array<double,1,1> CMSSM_mass_eigenstates::get_MPseudoscalarHiggs() const
{
 ...
 * @return mass of LSP
 */
double CMSSM_mass_eigenstates::get_lsp(CMSSM_info::Particles& particle_type) const
{
...
double CMSSM_mass_eigenstates::get_mass_matrix_VG() const
{
...
void CMSSM_mass_eigenstates::calculate_MVG()
{
   const auto mass_matrix_VG = get_mass_matrix_VG();
   MVG = calculate_singlet_mass(mass_matrix_VG);
}

double CMSSM_mass_eigenstates::get_mass_matrix_Glu() const
{
...
void CMSSM_mass_eigenstates::calculate_MGlu()
{
   const auto mass_matrix_Glu = get_mass_matrix_Glu();
   MGlu = calculate_singlet_mass(mass_matrix_Glu, PhaseGlu);
}

Eigen::Matrix<double,3,3> CMSSM_mass_eigenstates::get_mass_matrix_Fv() const
{
...
void CMSSM_mass_eigenstates::calculate_MFv()
{
   MFv.setConstant(0);
}

double CMSSM_mass_eigenstates::get_mass_matrix_VP() const
{
...
void CMSSM_mass_eigenstates::calculate_MVP()
{
   const auto mass_matrix_VP = get_mass_matrix_VP();
   MVP = calculate_singlet_mass(mass_matrix_VP);
}

double CMSSM_mass_eigenstates::get_mass_matrix_VZ() const
{
...
void CMSSM_mass_eigenstates::calculate_MVZ()
{
...
Eigen::Matrix<double,6,6> CMSSM_mass_eigenstates::get_mass_matrix_Sd() const
{
...
void CMSSM_mass_eigenstates::calculate_MSd()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Sd, eigenvalue_error > diagonalization_precision *
      Abs(MSd(0)));
#else
...
Eigen::Matrix<double,3,3> CMSSM_mass_eigenstates::get_mass_matrix_Sv() const
{
...
void CMSSM_mass_eigenstates::calculate_MSv()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Sv, eigenvalue_error > diagonalization_precision *
      Abs(MSv(0)));
#else
...
Eigen::Matrix<double,6,6> CMSSM_mass_eigenstates::get_mass_matrix_Su() const
{
...
void CMSSM_mass_eigenstates::calculate_MSu()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Su, eigenvalue_error > diagonalization_precision *
      Abs(MSu(0)));
#else
...
Eigen::Matrix<double,6,6> CMSSM_mass_eigenstates::get_mass_matrix_Se() const
{
...
void CMSSM_mass_eigenstates::calculate_MSe()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Se, eigenvalue_error > diagonalization_precision *
      Abs(MSe(0)));
#else
...
Eigen::Matrix<double,2,2> CMSSM_mass_eigenstates::get_mass_matrix_hh() const
{
...
void CMSSM_mass_eigenstates::calculate_Mhh()
{
   ...
   problems.flag_bad_mass(CMSSM_info::hh, eigenvalue_error > diagonalization_precision *
      Abs(Mhh(0)));
#else
...
Eigen::Matrix<double,2,2> CMSSM_mass_eigenstates::get_mass_matrix_Ah() const
{
...
void CMSSM_mass_eigenstates::calculate_MAh()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Ah, eigenvalue_error > diagonalization_precision *
      Abs(MAh(0)));
#else
...
Eigen::Matrix<double,2,2> CMSSM_mass_eigenstates::get_mass_matrix_Hpm() const
{
...
void CMSSM_mass_eigenstates::calculate_MHpm()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Hpm, eigenvalue_error > diagonalization_precision *
      Abs(MHpm(0)));
#else
...
Eigen::Matrix<double,4,4> CMSSM_mass_eigenstates::get_mass_matrix_Chi() const
{
...
void CMSSM_mass_eigenstates::calculate_MChi()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Chi, eigenvalue_error > diagonalization_precision *
      Abs(MChi(0)));
#else
...
Eigen::Matrix<double,2,2> CMSSM_mass_eigenstates::get_mass_matrix_Cha() const
{
...
void CMSSM_mass_eigenstates::calculate_MCha()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Cha, eigenvalue_error > diagonalization_precision *
      Abs(MCha(0)));
#else
...
Eigen::Matrix<double,3,3> CMSSM_mass_eigenstates::get_mass_matrix_Fe() const
{
...
void CMSSM_mass_eigenstates::calculate_MFe()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Fe, eigenvalue_error > diagonalization_precision *
      Abs(MFe(0)));
#else
...
Eigen::Matrix<double,3,3> CMSSM_mass_eigenstates::get_mass_matrix_Fd() const
{
...
void CMSSM_mass_eigenstates::calculate_MFd()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Fd, eigenvalue_error > diagonalization_precision *
      Abs(MFd(0)));
#else
...
Eigen::Matrix<double,3,3> CMSSM_mass_eigenstates::get_mass_matrix_Fu() const
{
...
void CMSSM_mass_eigenstates::calculate_MFu()
{
   ...
   problems.flag_bad_mass(CMSSM_info::Fu, eigenvalue_error > diagonalization_precision *
      Abs(MFu(0)));
#else
...
double CMSSM_mass_eigenstates::get_mass_matrix_VWm() const
{
...
void CMSSM_mass_eigenstates::calculate_MVWm()
{
...
double CMSSM_mass_eigenstates::get_ewsb_eq_hh_1() const
{
...
double CMSSM_mass_eigenstates::get_ewsb_eq_hh_2() const
{
...
double CMSSM_mass_eigenstates::get_tadpole_eq_hh_1(unsigned ewsb_loop_order) const
{
...
double CMSSM_mass_eigenstates::get_tadpole_eq_hh_2(unsigned ewsb_loop_order) const
{
...
std::complex<double> CMSSM_mass_eigenstates::CpUSdconjUSdVZVZ(unsigned gO1, unsigned gO2) const
{
...
double CMSSM_mass_eigenstates::CpUSdconjUSdconjVWmVWm(unsigned gO1, unsigned gO2) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSdconjUSdAhAh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSdconjUSdconjHpmHpm(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSdconjUSdhhhh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSdconjUSdconjSvSv(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdFuChaPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdFuChaPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdFdChiPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdFdChiPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSdconjUSdconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSdconjUSdconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSdconjUSdconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdSdAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdSdhh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdSuHpm(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdGluFdPR(unsigned gO2, unsigned , unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdGluFdPL(unsigned gO1, unsigned , unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdVGSd(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdVPSd(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdVZSd(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSdVWmSu(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSvconjUSvVZVZ(unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpUSvconjUSvconjVWmVWm(unsigned gO1, unsigned gO2) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSvconjUSvAhAh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSvconjUSvconjHpmHpm(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSvconjUSvhhhh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSvbarChaFePR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSvbarChaFePL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSvconjHpmSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSvconjUSvconjSvSv(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSvSvhh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpconjUSvFvChiPR(unsigned , unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSvFvChiPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSvconjUSvconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSvconjUSvconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSvconjUSvconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSvVZSv(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSvconjVWmSe(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSuconjUSuVZVZ(unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpUSuconjUSuconjVWmVWm(unsigned gO1, unsigned gO2) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSuconjUSuAhAh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSuconjUSuconjHpmHpm(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSuconjUSuhhhh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSubarChaFdPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSubarChaFdPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuconjHpmSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSuconjUSuconjSvSv(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuFuChiPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuFuChiPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSuconjUSuconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSuconjUSuconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSuconjUSuconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuSuAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuSuhh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuGluFuPR(unsigned gO2, unsigned , unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuGluFuPL(unsigned gO1, unsigned , unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuconjVWmSd(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuVGSu(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuVPSu(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSuVZSu(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSeconjUSeVZVZ(unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpUSeconjUSeconjVWmVWm(unsigned gO1, unsigned gO2) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSeconjUSeAhAh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSeconjUSeconjHpmHpm(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSeconjUSehhhh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSeconjUSeconjSvSv(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSeSvHpm(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpconjUSeFvChaPR(unsigned , unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSeFvChaPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSeFeChiPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSeFeChiPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSeconjUSeconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSeconjUSeconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUSeconjUSeconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSeSeAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSeSehh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSeVWmSv(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSeVPSe(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUSeVZSe(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhVZVZ(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhconjVWmVWm(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbargWmgWm(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbargWmCgWmC(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbargZgZ(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhUhhVZVZ(unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhUhhconjVWmVWm(unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhUhhAhAh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhUhhconjHpmHpm(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhUhhhhhh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhAhAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhconjHpmHpm(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhhhhh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbarChaChaPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbarChaChaPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhUhhconjSvSv(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhconjSvSv(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbarFdFdPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbarFdFdPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbarFeFePR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbarFeFePL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbarFuFuPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhbarFuFuPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhChiChiPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhChiChiPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhUhhconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhUhhconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhUhhconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhconjSdSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhconjSeSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhconjSuSu(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhVZAh(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUhhconjVWmHpm(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhbargWmgWm(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhbargWmCgWmC(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhUAhVZVZ(unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhUAhconjVWmVWm(unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhUAhAhAh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhUAhconjHpmHpm(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhUAhhhhh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhconjHpmHpm(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhhhAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhbarChaChaPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhbarChaChaPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhUAhconjSvSv(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhbarFdFdPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhbarFdFdPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhbarFeFePR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhbarFeFePL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhbarFuFuPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhbarFuFuPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhChiChiPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhChiChiPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhUAhconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhUAhconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhUAhconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhconjSdSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhconjSeSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhconjSuSu(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhVZhh(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUAhconjVWmHpm(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmVWmVP(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmVZVWm(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmbargWmCgZ(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmgWmCbargZ(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmbargZgWm(unsigned gO1) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmgZbargWm(unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmconjUHpmVZVZ(unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmconjUHpmconjVWmVWm(unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmconjUHpmAhAh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmconjUHpmconjHpmHpm(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmconjUHpmhhhh(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmHpmAh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmHpmhh(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmconjUHpmconjSvSv(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmbarFuFdPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmbarFuFdPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmbarFvFePR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpconjUHpmbarFvFePL(unsigned , unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmconjSvSe(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmChiChaPR(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmChiChaPL(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmconjUHpmconjSdSd(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmconjUHpmconjSeSe(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUHpmconjUHpmconjSuSu(unsigned gO1, unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmconjSuSd(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmVWmAh(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmVWmhh(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmVPHpm(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjUHpmVZHpm(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpVZbargWmgWm() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZbargWmCgWmC() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZconjVWmVWm() const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZVZAhAh(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZVZconjHpmHpm(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZVZhhhh(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpVZconjHpmHpm(unsigned gI1, unsigned gI2) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZhhAh(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZbarChaChaPL(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZbarChaChaPR(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZVZconjSvSv(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpVZconjSvSv(unsigned gI1, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZbarFdFdPL(unsigned gI1, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZbarFdFdPR(unsigned gI1, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZbarFeFePL(unsigned gI1, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZbarFeFePR(unsigned gI1, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZbarFuFuPL(unsigned gI1, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZbarFuFuPR(unsigned gI1, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZbarFvFvPL(unsigned gI1, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZbarFvFvPR(unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZChiChiPL(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZChiChiPR(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZVZconjSdSd(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZVZconjSeSe(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZVZconjSuSu(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZconjSdSd(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZconjSeSe(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZconjSuSu(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZVZhh(unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVZconjVWmHpm(unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpVZVZconjVWmVWm1() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZVZconjVWmVWm2() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVZVZconjVWmVWm3() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpconjVWmbargPgWm() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpconjVWmbargWmCgP() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpconjVWmbargWmCgZ() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpconjVWmbargZgWm() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpconjVWmVWmVP() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpconjVWmVZVWm() const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpVWmconjVWmAhAh(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVWmconjVWmconjHpmHpm(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVWmconjVWmhhhh(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmHpmAh(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmHpmhh(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpVWmconjVWmconjSvSv(unsigned gI1, unsigned gI2) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmbarFuFdPL(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpconjVWmbarFuFdPR(unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmbarFvFePL(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpconjVWmbarFvFePR(unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmconjSvSe(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmChiChaPL(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmChiChaPR(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVWmconjVWmconjSdSd(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVWmconjVWmconjSeSe(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpVWmconjVWmconjSuSu(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmconjSuSd(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmVPHpm(unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmVWmhh(unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpconjVWmVZHpm(unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpVWmconjVWmVPVP1() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVWmconjVWmVPVP2() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVWmconjVWmVPVP3() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVWmconjVWmVZVZ1() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVWmconjVWmVZVZ2() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVWmconjVWmVZVZ3() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVWmconjVWmconjVWmVWm1() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVWmconjVWmconjVWmVWm2() const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpVWmconjVWmconjVWmVWm3() const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjHpmChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjHpmChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChihhChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChihhChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjSvFvPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpUChiconjSvFvPR(unsigned , unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiChiAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiChiAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjSdFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjSdFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjSeFePL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjSeFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjSuFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjSuFuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjVWmChaPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiconjVWmChaPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiVZChiPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpUChiVZChiPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaChaAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaChaAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChahhChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChahhChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaHpmChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaHpmChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaconjSvFePL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaconjSvFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChabarFuSdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChabarFuSdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarUChabarFvSePL(unsigned , unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChabarFvSePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaconjSuFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaconjSuFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaVPChaPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaVPChaPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaVZChaPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaVZChaPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaVWmChiPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUChaVWmChiPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFehhFePL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFehhFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeHpmFvPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarUFeHpmFvPR(unsigned , unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeFeAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeFeAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeSvChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeSvChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeSeChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeSeChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeVPFePR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeVPFePL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarUFeVWmFvPR(unsigned , unsigned ) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpbarUFeVWmFvPL(unsigned gO1, unsigned gI2) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeVZFePR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFeVZFePL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdhhFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdhhFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdHpmFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdHpmFuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdFdAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdFdAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdSuChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdSuChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdSdChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdSdChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdSdGluPL(unsigned gO2, unsigned gI1, unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdSdGluPR(unsigned gO1, unsigned gI1, unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdVGFdPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdVGFdPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdVPFdPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdVPFdPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarUFdVWmFuPR(unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdVWmFuPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdVZFdPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFdVZFdPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuconjHpmFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuconjHpmFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuhhFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuhhFuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFubarChaSdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFubarChaSdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuFuAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuFuAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuSuChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuSuChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuSuGluPL(unsigned gO2, unsigned gI1, unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuSuGluPR(unsigned gO1, unsigned gI1, unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuVGFuPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuVGFuPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuVPFuPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuVPFuPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuVZFuPR(unsigned gO2, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuVZFuPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarUFuconjVWmFdPR(unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarUFuconjVWmFdPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpGluconjSdFdPL(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpGluconjSdFdPR(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpGluconjSuFuPL(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpGluconjSuFuPR(unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpGluVGGluPR() const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpGluVGGluPL() const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFehhFePL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFehhFePR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFeHpmFvPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarFeHpmFvPR(unsigned , unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFeFeAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFeFeAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFeSvChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFeSvChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFeSeChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFeSeChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarFeVWmFvPR(unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFeVWmFvPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarFeVZFePR(unsigned gO2, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpbarFeVZFePL(unsigned gO1, unsigned gI2) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdhhFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdhhFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdHpmFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdHpmFuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdFdAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdFdAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdSuChaPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdSuChaPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdSdChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdSdChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdSdGluPL(unsigned gO2, unsigned gI1, unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdSdGluPR(unsigned gO1, unsigned gI1, unsigned ) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarFdVWmFuPR(unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFdVWmFuPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarFdVZFdPR(unsigned gO2, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpbarFdVZFdPL(unsigned gO1, unsigned gI2) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuconjHpmFdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuconjHpmFdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuhhFuPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuhhFuPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFubarChaSdPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFubarChaSdPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuFuAhPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuFuAhPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuSuChiPL(unsigned gO2, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuSuChiPR(unsigned gO1, unsigned gI1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuSuGluPL(unsigned gO2, unsigned gI1, unsigned ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuSuGluPR(unsigned gO1, unsigned gI1, unsigned ) const
{
   std::complex<double> result;
...
double CMSSM_mass_eigenstates::CpbarFuVPFuPR(unsigned gO2, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpbarFuVPFuPL(unsigned gO1, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpbarFuVZFuPR(unsigned gO2, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpbarFuVZFuPL(unsigned gO1, unsigned gI2) const
{
   double result = 0.0;
...
double CMSSM_mass_eigenstates::CpbarFuconjVWmFdPR(unsigned , unsigned ) const
{
   double result = 0.0;
...
std::complex<double> CMSSM_mass_eigenstates::CpbarFuconjVWmFdPL(unsigned gO1, unsigned gI2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Sd(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Sv(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Su(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Se(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_hh(double p , unsigned gO1, unsigned gO2) const
{
   // note
   std::cout << "=======================================\n"
   ...
   // note
   std::cout << "-(B0(" << p << ",MVWm,MVWm)*CpUhhbargWmCgWmC("
             << gO1 << ")*CpUhhbargWmCgWmC(" << gO2 << ")) = "
             << -(B0(p,MVWm,MVWm)*CpUhhbargWmCgWmC(gO1)*CpUhhbargWmCgWmC(gO2)) << '\n';
   // note
   std::cout << "result = " << result << '\n';
   result += -(B0(p,MVWm,MVWm)*CpUhhbargWmgWm(gO1)*CpUhhbargWmgWm(gO2));
   // note
   std::cout << "-(B0(" << p << ",MVWm,MVWm)*CpUhhbargWmgWm("
             << gO1 << ")*CpUhhbargWmgWm(" << gO2 << ")) = "
             << -(B0(p,MVWm,MVWm)*CpUhhbargWmgWm(gO1)*CpUhhbargWmgWm(gO2)) << '\n';
   // note
   std::cout << "result = " << result << '\n';
   result += -(B0(p,MVZ,MVZ)*CpUhhbargZgZ(gO1)*CpUhhbargZgZ(gO2));
   // note
   std::cout << "-(B0(" << p << ",MVZ,MVZ)*CpUhhbargZgZ("
             << gO1 << ")*CpUhhbargZgZ(" << gO2 << ")) = "
             << -(B0(p,MVZ,MVZ)*CpUhhbargZgZ(gO1)*CpUhhbargZgZ(gO2)) << '\n';
   // note
   std::cout << "result = " << result << '\n';
   result += 4*B0(p,MVWm,MVWm)*Conj(CpUhhconjVWmVWm(gO2))*CpUhhconjVWmVWm(gO1);
   // note
   std::cout << "4*B0(" << p << ",MVWm,MVWm)*Conj(CpUhhconjVWmVWm("
             << gO2 << "))*CpUhhconjVWmVWm(" << gO1 << ") = "
             << 4*B0(p,MVWm,MVWm)*Conj(CpUhhconjVWmVWm(gO2))*CpUhhconjVWmVWm(gO1) << '\n';
   // note
   std::cout << "result = " << result << '\n';
   result += 4*A0(MVWm)*CpUhhUhhconjVWmVWm(gO1,gO2);
   // note
   std::cout << "4*A0(MVWm)*CpUhhUhhconjVWmVWm(" << gO1 << "," << gO2 << ") = "
             << 4*A0(MVWm)*CpUhhUhhconjVWmVWm(gO1,gO2) << '\n';
   // note
   std::cout << "result = " << result << '\n';
   result += 2*A0(MVZ)*CpUhhUhhVZVZ(gO1,gO2);
   // note
   std::cout << "2*A0(MVZ)*CpUhhUhhVZVZ(" << gO1 << "," << gO2 << ") = "
             << 2*A0(MVZ)*CpUhhUhhVZVZ(gO1,gO2) << '\n';
   // note
   std::cout << "result = " << result << '\n';
   result += 2*B0(p,MVZ,MVZ)*Conj(CpUhhVZVZ(gO2))*CpUhhVZVZ(gO1);
   // note
   std::cout << "2*B0(" << p << ",MVZ,MVZ)*Conj(CpUhhVZVZ("
             << gO2 << "))*CpUhhVZVZ(" << gO1 << ") = "
             << 2*B0(p,MVZ,MVZ)*Conj(CpUhhVZVZ(gO2))*CpUhhVZVZ(gO1) << '\n';
   std::complex<double> tmp_1867;
   std::complex<double> tmp_1868;
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      tmp_1868 += A0(MAh(gI1))*CpUhhUhhAhAh(gO1,gO2,gI1,gI1);
      // note
      std::cout << "(-0.5)*(A0(MAh(" << gI1 << "))*CpUhhUhhAhAh("
                << gO1 << "," << gO2 << "," << gI1 << "," << gI1 << ")) = "
                << (-0.5)*(A0(MAh(gI1))*CpUhhUhhAhAh(gO1,gO2,gI1,gI1)) << '\n';
   }
   tmp_1867 += tmp_1868;
   result += (-0.5) * tmp_1867;
   // note
   std::cout << "(-0.5) * tmp_1867 = " << (-0.5) * tmp_1867 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      // note
      std::cout << "(-1)*(A0(MHpm(" << gI1 << "))*CpUhhUhhconjHpmHpm("
                << gO1 << "," << gO2 << "," << gI1 << "," << gI1 << ")) = "
                << (-1)*(A0(MHpm(gI1))*CpUhhUhhconjHpmHpm(gO1,gO2,gI1,gI1)) << '\n';
   }
   tmp_1869 += tmp_1870;
   result += (-1) * tmp_1869;
   // note
   std::cout << "(-1) * tmp_1869 = " << (-1) * tmp_1869 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      // note
      std::cout << "(-0.5)*(A0(Mhh(" << gI1 << "))*CpUhhUhhhhhh("
                << gO1 << "," << gO2 << "," << gI1 << "," << gI1 << ")) = "
                << (-0.5)*(A0(Mhh(gI1))*CpUhhUhhhhhh(gO1,gO2,gI1,gI1)) << '\n';
   }
   tmp_1871 += tmp_1872;
   result += (-0.5) * tmp_1871;
   // note
   std::cout << "(-0.5) * tmp_1871 = " << (-0.5) * tmp_1871 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         ...
         // note
         std::cout << "(0.5)*(B0(" << p << ",MAh(" << gI1 << "),MAh("
                   << gI2 << "))*Conj(CpUhhAhAh(" << gO2 << "," << gI1
                   << "," << gI2 << "))*CpUhhAhAh(" << gO1 << ","
                   << gI1 << "," << gI2 << ")) = "
                   << (0.5)*(B0(p,MAh(gI1),MAh(gI2))*Conj(CpUhhAhAh(gO2,gI1,gI2))
                             *CpUhhAhAh(gO1,gI1,gI2)) << '\n';
      }
      tmp_1874 += tmp_1875;
   }
   ...
   result += (0.5) * tmp_1873;
   // note
   std::cout << "(0.5) * tmp_1873 = " << (0.5) * tmp_1873 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         ...
         // note
         std::cout << "B0(" << p << ",MHpm(" << gI1 << "),MHpm("
                   << gI2 << "))*Conj(CpUhhconjHpmHpm(" << gO2
                   << "," << gI1 << "," << gI2
                   << "))*CpUhhconjHpmHpm(" << gO1 << "," << gI1
                   << "," << gI2 << ") = "
                   << B0(p,MHpm(gI1),MHpm(gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         ...
         // note
         std::cout << "(0.5)*(B0(" << p << ",Mhh(" << gI1
                   << "),Mhh(" << gI2 << "))*Conj(CpUhhhhhh("
                   << gO2 << "," << gI1 << "," << gI2
                   << "))*CpUhhhhhh(" << gO1 << "," << gI1
                   << "," << gI2 << ")) = "
                   << (0.5)*(B0(p,Mhh(gI1),Mhh(gI2))*Conj(CpUhhhhhh(gO2,gI1,gI2))
                             *CpUhhhhhh(gO1,gI1,gI2)) << '\n';
      }
      tmp_1879 += tmp_1880;
   }
   ...
   result += (0.5) * tmp_1878;
   // note
   std::cout << "(0.5) * tmp_1878 = " << (0.5) * tmp_1878 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         ...
         // note
         std::cout << "(Conj(CpUhhbarChaChaPL(" << gO2 << "," << gI1
                   << "," << gI2 << "))*CpUhhbarChaChaPL(" << gO1
                   << "," << gI1 << "," << gI2 << ") + Conj(CpUhhbarChaChaPR("
                   << gO2 << "," << gI1 << "," << gI2
                   << "))*CpUhhbarChaChaPR(" << gO1 << "," << gI1 << ","
                   << gI2 << "))*G0(" << p << ",MCha(" << gI1 << "),MCha("
                   << gI2 << ")) = "
                   << (Conj(CpUhhbarChaChaPL(gO2,gI1,gI2))*
                       CpUhhbarChaChaPL(gO1,gI1,gI2) + Conj(CpUhhbarChaChaPR(gO2,gI1,gI2))*
                       CpUhhbarChaChaPR(gO1,gI1,gI2))*G0(p,MCha(gI1),MCha(gI2))
                   << '\n';
      }
   ...
   for (unsigned gI1 = 0; gI1 < 2; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
         ...
         // note
         std::cout << "(-2)*MCha(" << gI1 << ")*(B0(" << p << ",MCha("
                   << gI1 << "),MCha(" << gI2 << "))*(Conj(CpUhhbarChaChaPR("
                   << gO2 << "," << gI1 << "," << gI2 << "))*CpUhhbarChaChaPL("
                   << gO1 << "," << gI1 << "," << gI2 << ") + Conj(CpUhhbarChaChaPL("
                   << gO2 << "," << gI1 << "," << gI2 << "))*CpUhhbarChaChaPR("
                   << gO1 << "," << gI1 << "," << gI2 << "))*MCha(" << gI2
                   << ")) = "
                   << (-2)*MCha(gI1)*(B0(p,MCha(gI1),MCha(gI2))*
   ...
   result += (-2) * tmp_1883;
   // note
   std::cout << "(-2) * tmp_1883 = " << (-2) * tmp_1883 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      // note
      std::cout << "(-1)*(A0(MSv(" << gI1 << "))*CpUhhUhhconjSvSv("
                << gO1 << "," << gO2 << "," << gI1 << "," << gI1
                << ")) = "
                << (-1)*(A0(MSv(gI1))*CpUhhUhhconjSvSv(gO1,gO2,gI1,gI1))
                << '\n';
   }
   tmp_1887 += tmp_1888;
   result += (-1) * tmp_1887;
   // note
   std::cout << "(-1) * tmp_1887 = " << (-1) * tmp_1887 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         ...
         // note
         std::cout << "B0(" << p << ",MSv(" << gI1 << "),MSv("
                   << gI2 << "))*Conj(CpUhhconjSvSv(" << gO2 << ","
                   << gI1 << "," << gI2 << "))*CpUhhconjSvSv(" << gO1
                   << "," << gI1 << "," << gI2 << ") = "
                   << B0(p,MSv(gI1),MSv(gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         ...
         // note
         std::cout << "(3)*((Conj(CpUhhbarFdFdPL(" << gO2 << "," << gI1
                   << "," << gI2 << "))*CpUhhbarFdFdPL(" << gO1 << ","
                   << gI1 << "," << gI2 << ") + Conj(CpUhhbarFdFdPR("
                   << gO2 << "," << gI1 << "," << gI2 << "))*CpUhhbarFdFdPR("
                   << gO1 << "," << gI1 << "," << gI2 << "))*G0(" << p
                   << ",MFd(" << gI1 << "),MFd(" << gI2 << "))) = "
                   << (3)*((Conj(CpUhhbarFdFdPL(gO2,gI1,gI2))*CpUhhbarFdFdPL(
   ...
   result += (3) * tmp_1891;
   // note
   std::cout << "(3) * tmp_1891 = " << (3) * tmp_1891 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         ...
         // note
         std::cout << "(Conj(CpUhhbarFeFePL(" << gO2 << "," << gI1 << ","
                   << gI2 << "))*CpUhhbarFeFePL(" << gO1 << "," << gI1
                   << "," << gI2 << ") + Conj(CpUhhbarFeFePR(" << gO2
                   << "," << gI1 << "," << gI2 << "))*CpUhhbarFeFePR("
                   << gO1 << "," << gI1 << "," << gI2 << "))*G0(" << p
                   << ",MFe(" << gI1 << "),MFe(" << gI2 << ")) = "
                   << (Conj(CpUhhbarFeFePL(gO2,gI1,gI2))*CpUhhbarFeFePL(
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         ...
         // note
         std::cout << "(3)*((Conj(CpUhhbarFuFuPL(" << gO2 << "," << gI1
                   << "," << gI2 << "))*CpUhhbarFuFuPL(" << gO1 << ","
                   << gI1 << "," << gI2 << ") + Conj(CpUhhbarFuFuPR("
                   << gO2 << "," << gI1 << "," << gI2 << "))*CpUhhbarFuFuPR("
                   << gO1 << "," << gI1 << "," << gI2 << "))*G0(" << p
                   << ",MFu(" << gI1 << "),MFu(" << gI2 << "))) = "
                   << (3)*((Conj(CpUhhbarFuFuPL(gO2,gI1,gI2))*CpUhhbarFuFuPL(
   ...
   result += (3) * tmp_1896;
   // note
   std::cout << "(3) * tmp_1896 = " << (3) * tmp_1896 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         ...
         // note
         std::cout << "(-6)*MFd(" << gI1 << ")*(B0(" << p << ",MFd("
                   << gI1 << "),MFd(" << gI2 << "))*(Conj(CpUhhbarFdFdPR("
                   << gO2 << "," << gI1 << "," << gI2 << "))*CpUhhbarFdFdPL("
                   << gO1 << "," << gI1 << "," << gI2
                   << ") + Conj(CpUhhbarFdFdPL(" << gO2 << "," << gI1
                   << "," << gI2 << "))*CpUhhbarFdFdPR(" << gO1 << ","
                   << gI1 << "," << gI2 << "))*MFd(gI2)) = "
                   << (-6)*MFd(gI1)*(B0(p,MFd(gI1),MFd(gI2))*
                                     (Conj(CpUhhbarFdFdPR(gO2,gI1,gI2))*CpUhhbarFdFdPL(gO1,gI1,gI2)
                                      + Conj(CpUhhbarFdFdPL(gO2,gI1,gI2))
                                      *CpUhhbarFdFdPR(gO1,gI1,gI2))*MFd(gI2)) << '\n';
      }
      tmp_1901 += tmp_1902;
   ...
   result += (-6) * tmp_1899;
   // note
   std::cout << "(-6) * tmp_1899 = " << (-6) * tmp_1899 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         ...
         // note
         std::cout << "(-2)*MFe(gI1)*(B0(" << p << ",MFe(" << gI1 << "),MFe("
                   << gI2 << "))*(Conj(CpUhhbarFeFePR(" << gO2 << "," << gI1
                   << "," << gI2 << "))*CpUhhbarFeFePL(" << gO1 << ","
                   << gI1 << "," << gI2 << ") + Conj(CpUhhbarFeFePL(" << gO2
                   << "," << gI1 << "," << gI2 << "))*CpUhhbarFeFePR("
                   << gO1 << "," << gI1 << "," << gI2 << "))*MFe(gI2)) = "
                   << (-2)*MFe(gI1)*(B0(p,MFe(gI1),MFe(gI2))*
                                     (Conj(CpUhhbarFeFePR(gO2,gI1,gI2))*CpUhhbarFeFePL(gO1,gI1,gI2)
                                      + Conj(CpUhhbarFeFePL(gO2,gI1,gI2))
                                      *CpUhhbarFeFePR(gO1,gI1,gI2))*MFe(gI2)) << '\n';
      }
      tmp_1905 += tmp_1906;
   ...
   result += (-2) * tmp_1903;
   // note
   std::cout << "(-2) * tmp_1903 = " << (-2) * tmp_1903 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 3; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 3; ++gI2) {
         ...
         // note
         std::cout << "(-6)*MFu(gI1)*(B0(" << p << ",MFu(" << gI1 << "),MFu("
                   << gI2 << "))*(Conj(CpUhhbarFuFuPR(" << gO2 << "," << gI1
                   << "," << gI2 << "))*CpUhhbarFuFuPL(" << gO1 << ","
                   << gI1 << "," << gI2 << ") + Conj(CpUhhbarFuFuPL("
                   << gO2 << "," << gI1 << "," << gI2 << "))*CpUhhbarFuFuPR("
                   << gO1 << "," << gI1 << "," << gI2 << "))*MFu(" << gI2
                   << ")) = "
                   << (-6)*MFu(gI1)*(B0(p,MFu(gI1),MFu(gI2))*
                                     (Conj(CpUhhbarFuFuPR(gO2,gI1,gI2))*CpUhhbarFuFuPL(gO1,gI1,gI2)
                                      + Conj(CpUhhbarFuFuPL(gO2,gI1,gI2))
                                      *CpUhhbarFuFuPR(gO1,gI1,gI2))*MFu(gI2)) << '\n';
      }
      tmp_1909 += tmp_1910;
   ...
   result += (-6) * tmp_1907;
   // note
   std::cout << "(-6) * tmp_1907 = " << (-6) * tmp_1907 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 4; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 4; ++gI2) {
         ...
         // note
         std::cout << "(0.5)*((Conj(CpUhhChiChiPL(" << gO2 << "," << gI1
                   << "," << gI2 << "))*CpUhhChiChiPL(" << gO1 << ","
                   << gI1 << "," << gI2 << ") + Conj(CpUhhChiChiPR("
                   << gO2 << "," << gI1 << "," << gI2 << "))*CpUhhChiChiPR("
                   << gO1 << "," << gI1 << "," << gI2 << "))*G0(" << p
                   << ",MChi(" << gI1 << "),MChi(" << gI2 << "))) = "
                   << (0.5)*((Conj(CpUhhChiChiPL(gO2,gI1,gI2))*
                              CpUhhChiChiPL(gO1,gI1,gI2)
                              + Conj(CpUhhChiChiPR(gO2,gI1,gI2))*CpUhhChiChiPR(gO1,gI1,gI2)
                                )*G0(p,MChi(gI1),MChi(gI2))) << '\n';
      }
      tmp_1912 += tmp_1913;
   }
   ...
   result += (0.5) * tmp_1911;
   // note
   std::cout << "(0.5) * tmp_1911 = " << (0.5) * tmp_1911 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 4; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 4; ++gI2) {
         ...
         // note
         std::cout << "(-1)*MChi(gI1)*(B0(" << p << ",MChi(" << gI1
                   << "),MChi(" << gI2 << "))*(Conj(CpUhhChiChiPR(" << gO2
                   << "," << gI1 << "," << gI2 << "))*CpUhhChiChiPL(" << gO1
                   << "," << gI1 << "," << gI2 << ") + Conj(CpUhhChiChiPL("
                   << gO2 << "," << gI1 << "," << gI2 << "))*CpUhhChiChiPR("
                   << gO1 << "," << gI1 << "," << gI2 << "))*MChi(" <<gI2
                   << ")) = "
                   << (-1)*MChi(gI1)*(B0(p,MChi(gI1),MChi(gI2))*
                                      (Conj(CpUhhChiChiPR(gO2,gI1,gI2))*CpUhhChiChiPL(gO1,gI1,gI2)
                                       + Conj(CpUhhChiChiPL(gO2,gI1,gI2)
                                          )*CpUhhChiChiPR(gO1,gI1,gI2))*MChi(gI2))
                   << '\n';
      }
      tmp_1916 += tmp_1917;
   ...
   result += (-1) * tmp_1914;
   // note
   std::cout << "(-1) * tmp_1914 = " << (-1) * tmp_1914 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      // note
      std::cout << "(-3)*(A0(MSd(" << gI1 << "))*CpUhhUhhconjSdSd("
                << gO1 << "," << gO2 << "," << gI1 << "," << gI1 << ")) = "
                << (-3)*(A0(MSd(gI1))*CpUhhUhhconjSdSd(gO1,gO2,gI1,gI1)) << '\n';
   }
   tmp_1918 += tmp_1919;
   result += (-3) * tmp_1918;
   // note
   std::cout << "(-3) * tmp_1918 = " << (-3) * tmp_1918 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      // note
      std::cout << "(-1)*(A0(MSe(" << gI1 << "))*CpUhhUhhconjSeSe("
                << gO1 << "," << gO2 << "," << gI1 << "," << gI1 << ")) = "
                << (-1)*(A0(MSe(gI1))*CpUhhUhhconjSeSe(gO1,gO2,gI1,gI1)) << '\n';
   }
   tmp_1920 += tmp_1921;
   result += (-1) * tmp_1920;
   // note
   std::cout << "(-1) * tmp_1920 = " << (-1) * tmp_1920 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      // note
      std::cout << " (-3)*(A0(MSu(" << gI1 << "))*CpUhhUhhconjSuSu("
                << gO1 << "," << gO2 << "," << gI1 << "," << gI1 << ")) = "
                << (-3)*(A0(MSu(gI1))*CpUhhUhhconjSuSu(gO1,gO2,gI1,gI1)) << '\n';
   }
   tmp_1922 += tmp_1923;
   result += (-3) * tmp_1922;
   // note
   std::cout << "(-3) * tmp_1922 = " << (-3) * tmp_1922 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         ...
         // note
         std::cout << "(3)*(B0(" << p << ",MSd(" << gI1 << "),MSd("
                   << gI2 << "))*Conj(CpUhhconjSdSd(" << gO2 << ","
                   << gI1 << "," << gI2 << "))*CpUhhconjSdSd(" << gO1
                   << "," << gI1 << "," << gI2 << ")) = "
                   << (3)*(B0(p,MSd(gI1),MSd(gI2))*
   ...
   result += (3) * tmp_1924;
   // note
   std::cout << "(3) * tmp_1924 = " << (3) * tmp_1924 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         ...
         // note
         std::cout << "B0(" << p << ",MSe(" << gI1 << "),MSe(" << gI2
                   << "))*Conj(CpUhhconjSeSe(" << gO2 << "," << gI1
                   << "," << gI2 << "))*CpUhhconjSeSe(" << gO1 << ","
                   << gI1 << "," << gI2 << ") = "
                   << B0(p,MSe(gI1),MSe(gI2))*
   ...
   for (unsigned gI1 = 0; gI1 < 6; ++gI1) {
      ...
      for (unsigned gI2 = 0; gI2 < 6; ++gI2) {
         ...
         // note
         std::cout << "(3)*(B0(" << p << ",MSu(" << gI1 << "),MSu("
                   << gI2 << "))*Conj(CpUhhconjSuSu(" << gO2 << ","
                   << gI1 << "," << gI2 << "))*CpUhhconjSuSu(" << gO1
                   << "," << gI1 << "," << gI2 << ")) = "
                   << (3)*(B0(p,MSu(gI1),MSu(gI2))*
   ...
   result += (3) * tmp_1929;
   // note
   std::cout << "(3) * tmp_1929 = " << (3) * tmp_1929 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_1932 += Conj(CpUhhVZAh(gO2,gI2))*CpUhhVZAh(gO1,gI2)*F0(p,MAh(gI2),
         MVZ);
      // note
      std::cout << "Conj(CpUhhVZAh(" << gO2 << "," << gI2 << "))*CpUhhVZAh("
                << gO1 << "," << gI2 << ")*F0(" << p << ",MAh(" << gI2
                << "),MVZ) = "
                << Conj(CpUhhVZAh(gO2,gI2))*CpUhhVZAh(gO1,gI2)*F0(p,MAh(gI2),
                                                                  MVZ)
                << '\n';
   }
   result += tmp_1932;
   // note
   std::cout << "tmp_1932 = " << tmp_1932 << '\n';
   // note
   std::cout << "result = " << result << '\n';
   ...
   for (unsigned gI2 = 0; gI2 < 2; ++gI2) {
      tmp_1934 += Conj(CpUhhconjVWmHpm(gO2,gI2))*CpUhhconjVWmHpm(gO1,gI2)*F0
         (p,MHpm(gI2),MVWm);
      // note
      std::cout << "(2)*(Conj(CpUhhconjVWmHpm(" << gO2 << "," << gI2
                << "))*CpUhhconjVWmHpm(" << gO1 << "," << gI2
                << ")*F0(" << p << ",MHpm(" << gI2 << "),MVWm)) = "
                << (2)*(Conj(CpUhhconjVWmHpm(gO2,gI2))*CpUhhconjVWmHpm(gO1,gI2)*F0
                        (p,MHpm(gI2),MVWm)) << '\n';
   }
   tmp_1933 += tmp_1934;
   result += (2) * tmp_1933;
   // note
   std::cout << "(2) * tmp_1933 = " << (2) * tmp_1933 << '\n';
   // note
   std::cout << "result = " << result << '\n';
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Ah(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Hpm(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_VZ(double p ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_VWm(double p ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Chi_1(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Chi_PR(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Chi_PL(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Cha_1(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Cha_PR(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Cha_PL(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fe_1(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fe_PR(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fe_PL(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fd_1(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fd_PR(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fd_PL(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fu_1(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fu_PR(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fu_PL(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Glu_1(double p ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Glu_PR(double p ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Glu_PL(double p ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_VZ_heavy(double p ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_VWm_heavy(double p ) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fe_1_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fe_PR_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fe_PL_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fd_1_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fd_PR_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fd_PL_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fu_1_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fu_PR_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fu_PL_heavy_rotated(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fu_1_heavy(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fu_PR_heavy(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::self_energy_Fu_PL_heavy(double p , unsigned gO1, unsigned gO2) const
{
   std::complex<double> result;
...
std::complex<double> CMSSM_mass_eigenstates::tadpole_hh(unsigned gO1) const
{
   std::complex<double> result;
...
void CMSSM_mass_eigenstates::calculate_MSu_3rd_generation(double& msf1, double& msf2, double& theta) const {
...
void CMSSM_mass_eigenstates::calculate_MSd_3rd_generation(double& msf1, double& msf2, double& theta) const {
   sfermions::Mass_data sf_data;
   sf_data.ml2 = Re(mq2(2,2));
...
void CMSSM_mass_eigenstates::calculate_MSv_3rd_generation(double& msf1, double& msf2, double& theta) const {
   sfermions::Mass_data sf_data;
...
void CMSSM_mass_eigenstates::calculate_MSe_3rd_generation(double& msf1, double& msf2, double& theta) const {
   sfermions::Mass_data sf_data;
   sf_data.ml2 = Re(ml2(2,2));
...
void CMSSM_mass_eigenstates::self_energy_hh_2loop(double result[3]) const
{
...
void CMSSM_mass_eigenstates::self_energy_Ah_2loop(double result[3]) const
{
   // calculate 3rd generation sfermion masses and mixing angles
   double mst_1, mst_2, theta_t;
   double msb_1, msb_2, theta_b;
...
void CMSSM_mass_eigenstates::tadpole_hh_2loop(double result[2]) const
{
   // calculate 3rd generation sfermion masses and mixing angles
   double mst_1, mst_2, theta_t;
   double msb_1, msb_2, theta_b;
...
void CMSSM_mass_eigenstates::calculate_MVG_pole()
{
   // diagonalization with medium precision
   PHYSICAL(MVG) = 0.;
}

void CMSSM_mass_eigenstates::calculate_MGlu_pole()
{
   // diagonalization with medium precision
...
void CMSSM_mass_eigenstates::calculate_MFv_pole()
{
   // diagonalization with medium precision
   PHYSICAL(MFv).setConstant(0.);
}

void CMSSM_mass_eigenstates::calculate_MVP_pole()
{
   // diagonalization with medium precision
   PHYSICAL(MVP) = 0.;
}

void CMSSM_mass_eigenstates::calculate_MVZ_pole()
{
...
void CMSSM_mass_eigenstates::calculate_MSd_pole()
{
...
void CMSSM_mass_eigenstates::calculate_MSv_pole()
{
...
void CMSSM_mass_eigenstates::calculate_MSu_pole()
{
...
void CMSSM_mass_eigenstates::calculate_MSe_pole()
{
...
void CMSSM_mass_eigenstates::calculate_Mhh_pole()
{
...
void CMSSM_mass_eigenstates::calculate_MAh_pole()
{
...
void CMSSM_mass_eigenstates::calculate_MHpm_pole()
{
...
void CMSSM_mass_eigenstates::calculate_MChi_pole()
{
   // diagonalization with medium precision
...
void CMSSM_mass_eigenstates::calculate_MCha_pole()
{
   // diagonalization with medium precision
...
void CMSSM_mass_eigenstates::calculate_MFe_pole()
{
   // diagonalization with medium precision
...
void CMSSM_mass_eigenstates::calculate_MFd_pole()
{
   // diagonalization with medium precision
   Eigen::Matrix<double,3,3> self_energy_1;
   Eigen::Matrix<double,3,3> self_energy_PL;
...
void CMSSM_mass_eigenstates::calculate_MFu_pole()
{
   // diagonalization with medium precision
...
void CMSSM_mass_eigenstates::calculate_MVWm_pole()
{
...
double CMSSM_mass_eigenstates::calculate_MVWm_pole(double p)
{
   if (!force_output && problems.is_tachyon(VWm))
      return 0.;
...
double CMSSM_mass_eigenstates::calculate_MVZ_pole(double p)
{
   if (!force_output && problems.is_tachyon(VZ))
      return 0.;
...
double CMSSM_mass_eigenstates::calculate_MFu_DRbar(double m_pole, int idx) const
{
...
double CMSSM_mass_eigenstates::calculate_MFd_DRbar(double m_sm_msbar, int idx) const
{
...
double CMSSM_mass_eigenstates::calculate_MFe_DRbar(double m_sm_msbar, int idx) const
{
   const double p = m_sm_msbar;
...
double CMSSM_mass_eigenstates::calculate_MFv_DRbar(double, int) const
{
   return 0.0;
}

double CMSSM_mass_eigenstates::calculate_MVP_DRbar(double)
{
   return 0.0;
}

double CMSSM_mass_eigenstates::calculate_MVZ_DRbar(double m_pole)
{
   const double p = m_pole;
   const double self_energy = Re(self_energy_VZ(p));
...
double CMSSM_mass_eigenstates::calculate_MVWm_DRbar(double m_pole)
{
   const double p = m_pole;
   const double self_energy = Re(self_energy_VWm(p));
   const double mass_sqr = Sqr(m_pole) + self_energy;
...
double CMSSM_mass_eigenstates::ThetaW() const
{
   return ArcTan((0.7745966692414834*g1)/g2);
}

double CMSSM_mass_eigenstates::v() const
{
